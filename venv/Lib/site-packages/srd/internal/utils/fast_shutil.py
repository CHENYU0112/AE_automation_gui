    ...
    for name in names:
        ...
        try:
            if os.path.islink(srcname):
                ...
                copytree(
                    srcname, dstname, symlinks, ignore, copy_function, dirs_exist_ok=dirs_exist_ok, chunksize=chunksize
                )
            else:
...
def copytree_xcopy(src, dst):
    if os.path.isdir(src):
        call(["xcopy", os.path.normpath(src), os.path.join(os.path.normpath(dst), "*"), "/E/H/Y/Q"], stdout=DEVNULL)
    else:
