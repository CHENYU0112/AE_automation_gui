...
class VCDparser:
    ...
    def parse_vcd(self, only_sigs=0, use_stdout=0, siglist=None):
        """
        ...
        all_sigs = 0 if len(usigs) else 1
            ...
            while True:
                ...
                if line[0] in ("b", "B", "r", "R"):
                    ...
                    if num_sigs == 0:
                        if all_sigs:
                            VCDParseError(
                                "Error: No signals were found in the "
                            ...
                            VCDParseError(
                                "Error: No matching signals were found "
                    ...
                    if (num_sigs > 1) and use_stdout:
                        VCDParseError(
                            "Error: There are too many signals "
    ...
    def calc_mult(self, statement):
        ...
        if ts_match:
            ...
            VCDParseError(
                "Error: Unsupported timescale found in VCD " "file: " + tscale + ".  Refer to the Verilog LRM."
            )
        ...
        if units in mults:
            ...
            VCDParseError(
                "Error: Unsupported timescale units found in VCD "
