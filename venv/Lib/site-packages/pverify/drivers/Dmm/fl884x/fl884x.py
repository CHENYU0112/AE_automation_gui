...
from .fl884x_dllwrap import *


class fl884x(IVICDriverWrapper):
    def __init__(self):
        super().__init__()
        self._dllwrap = fl884x_dllwrap()
        self._vi = None
        """:type : int"""
    ...
    def FetchMinMax(self, maximumTime):
        """

        :param maximumTime:
        :type maximumTime:
        """
        return self._dllwrap.FetchMinMax(self._vi, maximumTime)
    ...
    def ConfigureDB(self, dBEnable, dBReferenceImpedance):
        """

        :param dBEnable:
        :type dBEnable:
        :param dBReferenceImpedance:
        :type dBReferenceImpedance:
        """
        return self._dllwrap.ConfigureDB(self._vi, dBEnable, dBReferenceImpedance)

    def ConfigureDBM(self, dbmEnable, dBmReferenceImpedance):
        """

        :param dbmEnable:
        :type dbmEnable:
        :param dBmReferenceImpedance:
        :type dBmReferenceImpedance:
        """
        return self._dllwrap.ConfigureDBM(self._vi, dbmEnable, dBmReferenceImpedance)

    def ConfigureLimit(self, limitEnable, lowerLimit, upperLimit):
        """
        ...
        :type upperLimit:
        """
        return self._dllwrap.ConfigureLimit(self._vi, limitEnable, lowerLimit, upperLimit)

    def ConfigureNull(self, nullEnable, nullOffset):
        """
        ...
        :type nullOffset:
        """
        return self._dllwrap.ConfigureNull(self._vi, nullEnable, nullOffset)

    def ConfigureMinMax(self, minMaxEnable):
        """

        :param minMaxEnable:
        :type minMaxEnable:
        """
        return self._dllwrap.ConfigureMinMax(self._vi, minMaxEnable)
