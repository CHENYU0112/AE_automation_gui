...
Version 1.1.4.0		May 2017

Introducing the Ag3446x IVI Driver for the Keysight 3446x family of DMM
---------------------------------------------------------------------------
  This instrument driver provides access to the functionality of the
  Keysight 3446x through a COM server or ANSI C API which also complies
...
--------------------
  ...
  Keysight Instrument Drivers, IVI-COM-C Drivers, Ag3446x group.  It contains
...
---------------------------------
  ...
  to use the latest numbered IAg3446x[n] interface rather than the IAg3446x
  interface.  The IAg3446x[n].<interface> property will return a pointer
  to the new IAg3446x<interface>[n] interface.  The IAg3446x<interface>[n]
...
----------------
  Version     Date     Notes
  -------   --------   -----
  1.1.4.0	May 2017	Defect fixes
  1.1.2.0	Apr 2016	Defect fixes
  1.1.1.0   Mar 2015	Updated help file, added IVI-2014 Compliance, Rebranded Keysight Technologies, added support of 34465A & 34470A
  1.0.7.0   June 2013	Initial public release
...
Driver Identification:
  ...
  Revision:                       1.1.4.0
  Component Identifier:           Ag3446x.Ag3446x

Hardware Information:
  Instrument Manufacturer:        Keysight Technologies
  Supported Instrument Models:    34460A, 34461A
...
Test Setup Instrument:
  Instrument Models (FW Revision):	34465A (A.01.08-02.22-00.08-00.35-01-01)
  Bus Interface:			TCPIP
...
Test Setup Simulation:
  Instrument Models: (FW Rev N/A)	34460A, 34461A
  Bus Interface:			N/A
  Operating System (Service Pack):	Windows 7 (SP1)
