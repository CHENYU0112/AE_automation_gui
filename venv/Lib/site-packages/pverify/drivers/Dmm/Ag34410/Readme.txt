...
Version: 1.1.0.0		Oct 2014

Introducing the Agilent34410 IVI Driver for the Keysight 34410/34411/L4411A Digital Multimeters
---------------------------------------------------------------------------
  This instrument driver provides access to the functionality of the
  Keysight 34410/34411/L4411A through a COM server or ANSI C API which also complies
...
-------------
  ...
  Shared Components
	...
	IVI Shared Components Version: 2.2.1 or newer installed
	VISA Shared Components Version 1.6 or newer installed
...
--------------------
  ...
  Keysight Instrument Drivers, IVI-COM-C Drivers, Agilent34410 group.  It contains
...
---------------------------------
  ...
  to use the latest numbered IAgilent34410[n] interface rather than the IAgilent34410
  interface.  The IAgilent34410[n].<interface> property will return a pointer
  to the new IAgilent34410<interface>[n] interface.  The IAgilent34410<interface>[n]
...
----------------
  Version		Date			Notes
  -------		--------		-----
  1.1.0.0		Oct 2014	Updated help file, added IVI-2014 Compliance, Rebranded Keysight Technologies
  1.0.25.0		Apr 2013    	Defect "ModulePath64 value missing from IVI Config Store" is fixed.
  1.0.24.0		Apr 2012	Added 64 bit driver, MATLAB wrapper, updated help and example programs
  1.0.22.0		Jan 2010	Fixed driver I/O performance issue.
					Implementation of StatusSubRegister Enums  in the code.
					Addition of LabView, LabWindowsCVI, AnsiC example programs
					Simulation handling according to current standard
					Updated Installer for VS Documentation Integration
  1.0.19.0		Apr 2007	Removed Simulation Issue
 					Added IVI C Driver
					Removed get_Range Defect in IIviDmm Interface.
					Modifyied Example Programs
  1.0.8.0		Mar 2006	Added .NET policy file
					Miscellaneous bug fixes
					Updated simulation data file
  1.0.0.0		May 2005	Initial release
...
IviDmm Spec: IVI-4.2   Revision: 4.1
Group Capabilities Supported:
	IviDmmBase				yes
	IviDmmACMeasurement			yes
	IviDmmFrequencyMeasurement		yes
	IviDmmTemperatureMeasurement		yes
	IviDmmThermocouple			no
	IviDmmResistanceTemperatureDevice	yes
	IviDmmThermistor			yes
	IviDmmMultiPoint			yes
	IviDmmTriggerSlope			yes
	IviDmmSoftwareTrigger			yes
	IviDmmDeviceInfo			yes
	IviDmmAutoRangeValue			yes
	IviDmmAutoZero				yes
	IviDmmPowerLineFrequency		yes
...
Driver Identification:
  ...
  Description:                    IVI driver for the Agilent 34410/11 family of digital multimeters.
  Revision:                       1.1.0.0
  Component Identifier:           Agilent34410.Agilent34410

Hardware Information:
  Instrument Manufacturer:        Keysight Technologies
  Supported Instrument Models:    34410A, 34411A
  Supported Bus Interfaces:       TCPIP, GPIB, USB

32-bit Software Information:
  Supported Operating Systems:    Windows XP, Windows Vista 32-bit, Windows 7 32-bit, Windows 8 32-bit
...
Test Setup Instrument:
  Instrument Models (FW Revision):	34410A(2.35-1.00-0.09-46-04),34411A (2.03-2.02-0.09-43-6),
  Bus Interface:			TCPIP, USB, GPIB
  Operating System (Service Pack):	Windows 7 (SP1)
  OS Bitness/Application Bitness:	64-bit/32-bit
  VISA Vendor and Version:		Keysight VISA-COM (IO Libraries 16.3)
  IVI Shared Components Version:	2.2.1

Test Setup Simulation:
  Instrument Models: (FW Rev N/A)	34410A, 34411A, L4411A
  Bus Interface:			N/A
  Operating System (Service Pack):	Windows 7 (SP1)
...
Driver Installation Testing:
  Operating System (Service Pack): 	WindowsXP (SP3), Windows 7 (SP1), Windows 8
