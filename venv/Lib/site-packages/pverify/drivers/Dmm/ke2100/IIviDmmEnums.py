...
class IviDmmTriggerSourceEnum:
    IviDmmTriggerSourceImmediate = 1  # The DMM exits the Wait-For-Trigger state immediately after entering. It does not wait for a trigger of any kind.
...
class IviDmmSampleTriggerEnum:
    IviDmmSampleTriggerImmediate = 1  # The DMM exits the Wait-For-Sample-Trigger state immediately after entering. It does not wait for a trigger of any kind.
    ...
    IviDmmSampleTriggerInterval = 10  # The DMM exits the Wait-For-Sample-Trigger state when the length of time specified by the Sample Interval attribute elapses.
