...
Introducing the Keithley IVI Driver for 2100 and 2110 Series of Digital Multimeter
----------------------------------------------------------------------------------
The Keithley2100 IVI COM driver conforms to the IVI driver standards and specifications. The help file included with the driver contains the detailed driver functionality description and programming information.
...
The driver can be used with GPIB or USB.

Supported Instruments
---------------------
Model 2100,Model 2110
...
Help File
---------
  The help file (Keithley2100.chm) is located in the directory:
   <drive>:\Program Files\IVI Foundation\IVI\Drivers\Ke2100

Examples
---------
  The driver installs few examples written in VisualBasic 6.0, C Sharp .NET, C++ and VB.NET. Examples are located in the directory:
   <drive>:\Program Files\IVI Foundation\IVI\Drivers\Ke2100\Examples
...
----------------
  Version     Date         Notes
  -------   ------------   -----
  1.0.0     April,2012  Initial public release
...
Vendor:                         Keithley.
Description:                    2100 Series Digital Multimeter
Revision:                       1.0.
Component Identifier:           Keithley2100
IVI-C prefix:                   Ke2100

Hardware Information:
Instrument Manufacturer:        Keithley Instruments
Supported Instrument Models:    Model 2100,Model 2110
Supported Bus Interfaces:       GPIB,USB
