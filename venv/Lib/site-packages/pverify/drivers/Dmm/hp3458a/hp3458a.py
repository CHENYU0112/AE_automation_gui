...
from .hp3458a_dllwrap import *


class hp3458a(IVICDriverWrapper):
    def __init__(self):
        super().__init__()
        self._dllwrap = hp3458a_dllwrap()
        self._vi = None
        """:type : int"""
    ...
    def ConfigureACBandwidth(self, acMinFreq, acMaxFreq):
        """
        ...
        :type acMaxFreq:
        """
        return self._dllwrap.ConfigureACBandwidth(self._vi, acMinFreq, acMaxFreq)

    def ConfigureFrequencyVoltageRange(self, freqVoltageRange):
        """

        :param freqVoltageRange:
        :type freqVoltageRange:
        """
        return self._dllwrap.ConfigureFrequencyVoltageRange(self._vi, freqVoltageRange)
    ...
    def RecallState(self, stateName):
        """

        :param stateName:
        :type stateName:
        """
        return self._dllwrap.RecallState(self._vi, stateName)
    ...
    def SaveState(self, stateName):
        ...
        :type stateName:
        """
        return self._dllwrap.SaveState(self._vi, stateName)
    ...
    def DeleteState(self, stateName):
        ...
        :type stateName:
        """
        return self._dllwrap.DeleteState(self._vi, stateName)

    def DeleteStateMemory(self):
        """"""
        return self._dllwrap.DeleteStateMemory(self._vi)

    def FetchStats(self):
        """"""
        return self._dllwrap.FetchStats(self._vi)

    def FetchPassFail(self):
        """"""
        return self._dllwrap.FetchPassFail(self._vi)
    ...
    def ConfigureSubSamplingTrigger(self, syncSource, sweepCount, sweepIntervalsec):
        """
        ...
        :param sweepCount:
        :type sweepCount:
        :param sweepIntervalsec:
        :type sweepIntervalsec:
        """
        return self._dllwrap.ConfigureSubSamplingTrigger(self._vi, syncSource, sweepCount, sweepIntervalsec)
