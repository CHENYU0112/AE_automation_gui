...
from .Ag34401_dllwrap import *


class Ag34401(IVICDriverWrapper):
    def __init__(self):
        super().__init__()
        self._dllwrap = Ag34401_dllwrap()
        self._vi = None
        """:type : int"""
    ...
    def CalibrationSecureCode(self, SecureState, Code):
        """
        ...
        :type Code:
        """
        return self._dllwrap.CalibrationSecureCode(self._vi, SecureState, Code)

    def CalibrationCode(self, Code):
        """

        :param Code:
        :type Code:
        """
        return self._dllwrap.CalibrationCode(self._vi, Code)
    ...
    def StatusConfigureRegister(self, Register, SubRegister, Val):
        """
        ...
        :type Val:
        """
        return self._dllwrap.StatusConfigureRegister(self._vi, Register, SubRegister, Val)
    ...
    def SystemRead(self, Size, ValueBufferSize):
        """
        ...
        """
        return self._dllwrap.SystemRead(self._vi, Size, ValueBufferSize)
