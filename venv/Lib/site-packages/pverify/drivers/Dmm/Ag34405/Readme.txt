...
Version: 1.1.1.0		January, 2014

Introducing the Agilent34405 IVI Driver for the Agilent DMM
---------------------------------------------------------------------------
  This instrument driver provides access to the functionality of the
  34405A DMM through a COM server or ANSI C API which also complies
  ...
  .NET, Agilent VEE Pro, National Instruments LabView, LabWindows CVI, MATLAB(32
  bit only) and others.
...
-------------
  ...
  Shared Components
    Before this driver can be installed, your computer must already have the
	IVI Shared Components installed.

    Minimal IVI Version: 2.2.1
  ...
  VISA-COM
	...
	with VISA and other I/O library modules.  The latest version of Agilent's IO
...
--------------------
  ...
  Agilent IVI Drivers, Agilent34405 group.  It contains   "Getting Started"
...
---------------------------------
  New versions of this Agilent IVI-COM/C driver may have a new ProgId.
  ...
  to use the latest numbered IAgilent34405[n] interface rather than the IAgilent34405
  interface.  The IAgilent34405[n].<interface> property will return a pointer
  to the new IAgilent34405<interface>[n] interface.  The IAgilent34405<interface>[n]
...
----------------
  Version      Date       Notes
  -------   -----------   -----
  1.1.1.0   Jan, 2014	  Added Math function statistics functionality and added methods for direct IO functionality in System interface.
  1.0.0.0   Aug, 2008  	  Initial public release


IVI Compliance
--------------
IVI-COM/IVI-C IviDmm Compliant Instrument Specific Driver
...
IviDmmResistanceTemperatureDevice	no
IviDmmThermistor			yes
IviDmmMultiPoint			no
IviDmmTriggerSlope			no
IviDmmSoftwareTrigger			yes
IviDmmDeviceInfo			no
IviDmmAutoRangeValue			no
IviDmmAutoZero				no
IviDmmPowerLineFrequency		no
...
Driver Identification:
  ...
  Description:                    Agilent34405 DMM
  Revision:                       1.1
  Component Identifier:           Agilent34405.Agilent34405

Hardware Information:
  Instrument Manufacturer:        Agilent Technologies
  Supported Instrument Models:    34405A
  Supported Bus Interfaces:       USB
...
Test Setup Instrument:
  Instrument Models (FW Revision):	34405A (1.49-3.14)
...
Test Setup Simulation:
  Instrument Models: (FW Rev N/A)	34405A
  Bus Interface:			N/A
  Operating System (Service Pack):	Windows 7 (SP1)
...
Driver Installation Testing:
  Operating System (Service Pack): 	WindowsXP, Windows 7 (SP1), Windows 8
...
Agilent Technologies has evaluated and tested this driver to verify that it meets all applicable
...
----------------
  ...
  software available from Agilent Technologies visit:
...
Copyright 2005-2014 Agilent Technologies, Inc. All rights reserved.
