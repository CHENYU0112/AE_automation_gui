...
#define T32_TAPACCESS_TDIT32_TAPACCESS_TDI                0x04
...
T32EXTERN int  T32_TAPAccessShiftRaw(T32_BUNDLEDACCESS_HANDLE Handle, int NumberOfBits,  uint8_t *pTMSBits,  uint8_t *pTDIBits, uint8_t *pTDOBits, int Options);
T32EXTERN int  T32_TAPAccessShiftIR(T32_BUNDLEDACCESS_HANDLE Handle, int NumberOfBits,  uint8_t *pOutBits,  uint8_t *pInBits);
T32EXTERN int  T32_TAPAccessShiftDR(T32_BUNDLEDACCESS_HANDLE Handle, int NumberOfBits,  uint8_t *pOutBits,  uint8_t *pInBits);
...
T32EXTERN int  T32_TAPAccessDirect(T32_BUNDLEDACCESS_HANDLE Handle, int NumberOfBytes, uint8_t *pOutBytes, uint8_t *pInBytes);
...
T32EXTERN int  T32_I2CRawAccess(T32_BUNDLEDACCESS_HANDLE Handle, unsigned int nInstance, uint32_t *send, uint32_t *recv, int len);
...
# define SETQUADVAR(A,B) (((unsigned char *)&(A))[0]=((unsigned char *)&(B))[0],((unsigned char *)&(A))[1]=((unsigned char *)&(B))[1],((unsigned char *)&(A))[2]=((unsigned char *)&(B))[2],((unsigned char *)&(A))[3]=((unsigned char *)&(B))[3], \
...
# define SETQUADVAR(A,B) (((unsigned char *)&(A))[0]=((unsigned char *)&(B))[7],((unsigned char *)&(A))[1]=((unsigned char *)&(B))[6],((unsigned char *)&(A))[2]=((unsigned char *)&(B))[5],((unsigned char *)&(A))[3]=((unsigned char *)&(B))[4], \
