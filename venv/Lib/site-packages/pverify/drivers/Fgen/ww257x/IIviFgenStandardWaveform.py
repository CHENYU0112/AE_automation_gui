...
class IIviFgenStandardWaveform:
    ...
    def Configure(self, ChannelName, Waveform, Amplitude, DCOffset, Frequency, StartPhase):
        ...
        """
        if Waveform == WW257X_VAL_WFM_DC:
            self.root.dllwrap.ConfigureDClevel(ChannelName, DCOffset)
        else:
            self.root.dllwrap.ConfigureStandardWaveform(
                ChannelName, Waveform, Amplitude, DCOffset, Frequency, StartPhase
            )
