...
class IIviFgenOutput:
    ...
    @property
    def OutputMode(self):
        mode_ch1 = self.root.dllwrap.GetAttributeViInt32(self.Name(1), IVI_CLASS_PUBLIC_ATTR_BASE + 1)
        mode_ch2 = self.root.dllwrap.GetAttributeViInt32(self.Name(2), IVI_CLASS_PUBLIC_ATTR_BASE + 1)
        if mode_ch1 != mode_ch2:
            self.OutputMode = mode_ch1
        return mode_ch1
    ...
    def OutputMode(self, value):
        ...
        """
        self.root.dllwrap.SetAttributeViInt32(self.Name(1), IVI_CLASS_PUBLIC_ATTR_BASE + 1, value)
        self.root.dllwrap.SetAttributeViInt32(self.Name(2), IVI_CLASS_PUBLIC_ATTR_BASE + 1, value)
