...
from .tkafg31k_dllwrap import *


class tkafg31k(IVICDriverWrapper):
    def __init__(self):
        super().__init__()
        self._dllwrap = tkafg31k_dllwrap()
        self._vi = None
        """:type : int"""
    ...
    def ConfigureActiveChannel(self, channelName):
        """

        :param channelName:
        :type channelName:
        """
        return self._dllwrap.ConfigureActiveChannel(self._vi, channelName)
    ...
    def ClearArbWaveform(self, waveformHandle):
        """

        :param waveformHandle:
        :type waveformHandle:
        """
        return self._dllwrap.ClearArbWaveform(self._vi, waveformHandle)
    ...
    def ConfigureArbWaveformExtended(self, channelName, wfmHandle, arbGain, arbOffset, editFile):
        """
        ...
        :type editFile:
        """
        return self._dllwrap.ConfigureArbWaveformExtended(
            self._vi, channelName, wfmHandle, arbGain, arbOffset, editFile
        )
    ...
    def CreateArbSequence(self, length, waveformHandle, loopCount):
        """
        ...
        :type loopCount:
        """
        return self._dllwrap.CreateArbSequence(self._vi, length, waveformHandle, loopCount)

    def CreateSequence(self):
        """"""
        return self._dllwrap.CreateSequence(self._vi)

    def ConfigureArbSequence(self, channelName, seqHandle, arbGain, offset):
        """
        ...
        :type offset:
        """
        return self._dllwrap.ConfigureArbSequence(self._vi, channelName, seqHandle, arbGain, offset)

    def ConfigureSequenceScale(self, channelName, scale):
        """
        ...
        :type scale:
        """
        return self._dllwrap.ConfigureSequenceScale(self._vi, channelName, scale)

    def ClearArbMemory(self):
        """"""
        return self._dllwrap.ClearArbMemory(self._vi)

    def ClearArbSequence(self, sequenceHandle):
        """

        :param sequenceHandle:
        :type sequenceHandle:
        """
        return self._dllwrap.ClearArbSequence(self._vi, sequenceHandle)

    def ConfigureAddress(self, element, jumpIndex, GOTOIndex, enableInfiniteLoop, enableGOTO, loopCount):
        """
        ...
        :param GOTOIndex:
        :type GOTOIndex:
        :param enableInfiniteLoop:
        :type enableInfiniteLoop:
        :param enableGOTO:
        :type enableGOTO:
        :param loopCount:
        :type loopCount:
        """
        return self._dllwrap.ConfigureAddress(
            self._vi,
            element,
            jumpIndex,
            GOTOIndex,
    ...
    def ConfigureSequenceSamplingRate(self, samplingRate):
        """

        :param samplingRate:
        :type samplingRate:
        """
        return self._dllwrap.ConfigureSequenceSamplingRate(self._vi, samplingRate)

    def ConfigureSequenceJumpTrigger(self, element, jumpTriggerType, jumpTargetType, jumpTriggerSlopeType, timer):
        """

        :param element:
        :type element:
        :param jumpTriggerType:
        :type jumpTriggerType:
        :param jumpTargetType:
        :type jumpTargetType:
        :param jumpTriggerSlopeType:
        :type jumpTriggerSlopeType:
        :param timer:
        :type timer:
        """
        return self._dllwrap.ConfigureSequenceJumpTrigger(
            self._vi,
            element,
            jumpTriggerType,
            jumpTargetType,
            jumpTriggerSlopeType,
            timer,
        )

    def ConfigureSequenceWaveform(self, channelName, element, waveformPath, sequenceRunMode):
        """
        ...
        :param waveformPath:
        :type waveformPath:
        :param sequenceRunMode:
        :type sequenceRunMode:
        """
        return self._dllwrap.ConfigureSequenceWaveform(self._vi, channelName, element, waveformPath, sequenceRunMode)

    def ConfigureSequenceWaitTrigger(self, element, waitTriggerType, enableWaitTrigger, waitTriggerSlopeType, timer):
        """

        :param element:
        :type element:
        :param waitTriggerType:
        :type waitTriggerType:
        :param enableWaitTrigger:
        :type enableWaitTrigger:
        :param waitTriggerSlopeType:
        :type waitTriggerSlopeType:
        :param timer:
        :type timer:
        """
        return self._dllwrap.ConfigureSequenceWaitTrigger(
            self._vi,
            element,
            waitTriggerType,
            enableWaitTrigger,
            waitTriggerSlopeType,
            timer,
        )

    def ConfigureWaveformDelay(self, delay):
        """

        :param delay:
        :type delay:
        """
        return self._dllwrap.ConfigureWaveformDelay(self._vi, delay)

    def DeleteWaveform(self, waveformPath):
        """

        :param waveformPath:
        :type waveformPath:
        """
        return self._dllwrap.DeleteWaveform(self._vi, waveformPath)

    def ConfigureMarkerEnabled(self, element, markerEnabled):
        """
        ...
        :type markerEnabled:
        """
        return self._dllwrap.ConfigureMarkerEnabled(self._vi, element, markerEnabled)

    def StartSequenceOutput(self):
        """"""
        return self._dllwrap.StartSequenceOutput(self._vi)

    def StopSequenceOutput(self):
        """"""
        return self._dllwrap.StopSequenceOutput(self._vi)

    def ConfigureSequenceLength(self, sequenceLength):
        """

        :param sequenceLength:
        :type sequenceLength:
        """
        return self._dllwrap.ConfigureSequenceLength(self._vi, sequenceLength)
    ...
    def ConfigureStartTrigger(self, channelName, triggerSource, triggerSlope):
        """
        ...
        :type triggerSlope:
        """
        return self._dllwrap.ConfigureStartTrigger(self._vi, channelName, triggerSource, triggerSlope)
    ...
    def ConfigureBurstIdle(self, channelName, burstIdle):
        """
        ...
        :type burstIdle:
        """
        return self._dllwrap.ConfigureBurstIdle(self._vi, channelName, burstIdle)

    def RearmBurst(self, channelName):
        """

        :param channelName:
        :type channelName:
        """
        return self._dllwrap.RearmBurst(self._vi, channelName)
    ...
    def ConfigureAMInternal(self, modulationDepth, modulationWaveform, modulationFrequency):
        """

        :param modulationDepth:
        :type modulationDepth:
        :param modulationWaveform:
        :type modulationWaveform:
        :param modulationFrequency:
        :type modulationFrequency:
        """
        return self._dllwrap.ConfigureAMInternal(self._vi, modulationDepth, modulationWaveform, modulationFrequency)

    def ConfigureAMInternalByChannel(self, channelName, amDepth, amWaveform, amFrequency, editFile):
        """
        ...
        :type editFile:
        """
        return self._dllwrap.ConfigureAMInternalByChannel(
            self._vi, channelName, amDepth, amWaveform, amFrequency, editFile
        )
    ...
    def ConfigureFMInternal(self, peakDeviation_Hz, modulationWaveform, modulationFrequency_Hz):
        """

        :param peakDeviation_Hz:
        :type peakDeviation_Hz:
        :param modulationWaveform:
        :type modulationWaveform:
        :param modulationFrequency_Hz:
        :type modulationFrequency_Hz:
        """
        return self._dllwrap.ConfigureFMInternal(self._vi, peakDeviation_Hz, modulationWaveform, modulationFrequency_Hz)

    def ConfigureFMInternalByChannel(self, channelName, fmDeviance, fmWaveform, fmFrequency, editFile):
        """
        ...
        :type editFile:
        """
        return self._dllwrap.ConfigureFMInternalByChannel(
            self._vi, channelName, fmDeviance, fmWaveform, fmFrequency, editFile
        )
    ...
    def ConfigurePMInternalByChannel(self, channelName, pmDeviation, pmWaveform, pmFrequency, editFile):
        """
        ...
        :type editFile:
        """
        return self._dllwrap.ConfigurePMInternalByChannel(
            self._vi, channelName, pmDeviation, pmWaveform, pmFrequency, editFile
        )
    ...
    def ConfigurePWMInternalByChannel(self, channelName, pwmDeviation, pwmWaveform, pwmFrequency, editFile):
        """
        ...
        return self._dllwrap.ConfigurePWMInternalByChannel(
            self._vi, channelName, pwmDeviation, pwmWaveform, pwmFrequency, editFile
        )
    ...
    def QuerySequenceParameter(self, channelName):
        """

        :param channelName:
        :type channelName:
        """
        return self._dllwrap.QuerySequenceParameter(self._vi, channelName)

    def ListWaveforms(self, index):
        """

        :param index:
        :type index:
        """
        return self._dllwrap.ListWaveforms(self._vi, index)

    def SaveLoadSequence(self, operation, filePath):
        """
        ...
        :type filePath:
        """
        return self._dllwrap.SaveLoadSequence(self._vi, operation, filePath)
