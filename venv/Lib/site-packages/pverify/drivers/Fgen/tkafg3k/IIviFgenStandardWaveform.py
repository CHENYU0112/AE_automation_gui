...
class IIviFgenStandardWaveform:
    ...
    def Configure(self, ChannelName, Waveform, Amplitude, DCOffset, Frequency, StartPhase):
        ...
        """
        if Waveform == self.root.dllwrap.const.IVIFGEN_VAL_WFM_SQUARE:
            Waveform = self.root.dllwrap.const.TKAFG3K_VAL_WFM_PULS
    ...
    def get_DutyCycleHigh(self, ChannelName):
        ...
        :rtype: float
        """
        return self.root.dllwrap.GetAttributeViReal64(ChannelName, TKAFG3K_ATTR_PULSE_DUTY_CYCLE)
    ...
    def set_DutyCycleHigh(self, ChannelName, pVal):
        ...
        :type pVal: float
        """
        self.root.dllwrap.SetAttributeViReal64(ChannelName, TKAFG3K_ATTR_PULSE_DUTY_CYCLE, pVal)
