...
Version: 1.2.3.0	  December 2016

Introducing the AgilentNA IVI Driver for the Keysight AgilentNA family of Network Analyzers
---------------------------------------------------------------------------
  This instrument driver provides access to the functionality of the
  AgilentNA through a COM server or ANSI C API which also complies
...
---------------------
 ENA:  E5070B, E5071B, E5071C, E5072A, E5080A
 ENAL: E5061A, E5061B, E5062A, E5063A
 PNA:  E8361A, E8361C, E8362B, E8362C, E8363B, E8363C, E8364B, E8364C
 PNAL: N5230A, N5230C, N5241A, N5242A, N5244A, N5245A, N5264A, N5247A,
...
-------------
  ...
  Shared Components
    Before this driver can be installed, your computer must already have:
	  IVI Shared Components Version: 2.3.0 or newer installed
...
--------------------
  ...
  Keysight Instrument Drivers, IVI-COM-C Drivers, AgilentNA group.  It contains
...
---------------------------------
  ...
  to use the latest numbered IAgilentNA[n] interface rather than the IAgilentNA
  interface.  The IAgilentNA[n].<interface> property will return a pointer
  to the new IAgilentNA<interface>[n] interface.  The IAgilentNA<interface>[n]
...
----------------
  Version     Date     Notes
  -------   --------   -----
  1.2.3.0   Dec 2016   Defect fix
  1.2.2.0   Oct 2015   Added Model support for N5249A.
  1.2.0.0   Feb 2015    Updated help file, added IVI-2014 Compliance, Rebranded Keysight Technologies, Added support for E5080A model
  1.1.12.0  Jan 2014    Added model support for E5063A
  1.1.8.0   Oct 2012    Defect fixes after division QA
  1.1.7.0   Sep 2012    Defect fixes after division QA
  1.1.6.0   Jul 2012    Added support for N5222A, N5224A, N5225A, N5227A, N5239A, N5231A, N5232A, N5234A, N5235A.  Defect fixes, 64bit installer and MatLab wrapper driver.
  1.1.5.0   Jun 2011	Added support for ENA model E5072A
  1.1.4.0   Jun 2009	Added support for ENA model E5061B and PNA models N5241A, N5244A, N5245A
  1.1.3.0   Nov 2008	Added IVI-C, Updated Help, Simulation
  1.0.0.25  Feb 2008	Defect Fixes
  1.0.0.23  Nov 2006	First Release
...
Driver Identification:
  ...
  Description:                    IVI driver for Keysight Network Analyzers
  Revision:                       1.2.3.0
  Component Identifier:           AgilentNA.AgilentNA

Hardware Information:
  Instrument Manufacturer:        Keysight Technologies
  Supported Instrument Models:    E5070B, E5071B, E5071C, E5072A, E5061A, E5062A, E5061B, E5063A, E8361A, E8362B, E8363B, E8364B, E8361C, E8362C, E8363C, E8364C, N5230A, N5230C, N5241A, N5242A, N5244A, N5245A, N5264A, N5247A, N5221A, N5222A, N5224A, N5225A, N5227A, N5239A, N5231A, N5232A, N5234A, N5235A
...
Test Setup Instrument:
  Instrument Models (FW Revision):	N5247A(Z.09.99.11)
  Bus Interface:			TCPIP
...
Test Setup Simulation:
  Instrument Models: (FW Rev N/A)	N5247A ,E5070B
  Bus Interface:			N/A
  Operating System (Service Pack):	Windows 7 (SP1)
