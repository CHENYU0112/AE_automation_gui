...
class IIviDriverUtility:
    ...
    def Reset(self):
        ...
        """
        self.parent.interface.vi_setTimeout(20000)
        self.parent.interface.vi_write("*RST")
        sleep(8)
        self.parent.interface.vi_query("*IDN?")
        self.parent.interface.vi_setTimeout(5000)
    ...
    def SelfTest(self, TestResult, TestMessage):
        """
    ...
    def ErrorQuery(self):
        ...
        error.
        """
        ret = self.parent.interface.vi_query(":STAT:ERR?").strip().split(",")
