...
from . import hpe363xa_const as const
from .hpe363xa_const import *


class hpe363xa_dllwrap(IVICDriverWrapper):
    def __init__(self):
        super().__init__()
        self._dll = load_dll("hpe363xa_32.dll", "hpe363xa_64.dll", __file__)
        """:type : ctypes.WinDLL"""
    ...
    def init(self, resourceName, IDQuery, resetDevice):
        vi = ViSession()
        status = self.dll.hpe363xa_init(ViRsrc(resourceName), ViBoolean(IDQuery), ViBoolean(resetDevice), byref(vi))
        if int(status) < 0:
    ...
    def InitWithOptions(self, resourceName, IDQuery, resetDevice, optionString):
        newVi = ViSession()
        status = self.dll.hpe363xa_InitWithOptions(
            ViRsrc(resourceName),
            ViBoolean(IDQuery),
    ...
    def close(self, vi):
        status = self.dll.hpe363xa_close(ViSession(vi))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def GetNextCoercionRecord(self, vi, bufferSize):
        ...
        status = self.dll.hpe363xa_GetNextCoercionRecord(ViSession(vi), ViInt32(bufferSize), record)
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def LockSession(self, vi):
        ...
        status = self.dll.hpe363xa_LockSession(ViSession(vi), byref(callerHasLock))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def UnlockSession(self, vi):
        callerHasLock = ViBoolean()
        status = self.dll.hpe363xa_UnlockSession(ViSession(vi), byref(callerHasLock))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def ConfigureOutputEnabled(self, vi, channelName, enabled):
        status = self.dll.hpe363xa_ConfigureOutputEnabled(ViSession(vi), ViConstString(channelName), ViBoolean(enabled))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def ConfigureAllOutputEnabled(self, vi, outputEnabled):
        status = self.dll.hpe363xa_ConfigureAllOutputEnabled(ViSession(vi), ViBoolean(outputEnabled))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def ConfigureOutputRange(self, vi, channelName, rangeType, range):
        status = self.dll.hpe363xa_ConfigureOutputRange(
    ...
    def ConfigureCurrentLimit(self, vi, channelName, behavior, limit):
        status = self.dll.hpe363xa_ConfigureCurrentLimit(
    ...
    def ConfigureOVP(self, vi, channelName, enabled, limit):
        status = self.dll.hpe363xa_ConfigureOVP(
    ...
    def ConfigureVoltageLevel(self, vi, channelName, level):
        status = self.dll.hpe363xa_ConfigureVoltageLevel(ViSession(vi), ViConstString(channelName), ViReal64(level))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def QueryOutputState(self, vi, channelName, outputState):
        inState = ViBoolean()
        status = self.dll.hpe363xa_QueryOutputState(
            ViSession(vi),
    ...
    def QueryMaxCurrentLimit(self, vi, channelName, voltageLevel):
        ...
        status = self.dll.hpe363xa_QueryMaxCurrentLimit(
            ViSession(vi),
            ViConstString(channelName),
    ...
    def QueryMaxVoltageLevel(self, vi, channelName, currentLimit):
        ...
        status = self.dll.hpe363xa_QueryMaxVoltageLevel(
            ViSession(vi),
            ViConstString(channelName),
    ...
    def ResetOutputProtection(self, vi, channelName):
        status = self.dll.hpe363xa_ResetOutputProtection(ViSession(vi), ViConstString(channelName))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def ConfigureTriggerSource(self, vi, channelName, source):
        status = self.dll.hpe363xa_ConfigureTriggerSource(ViSession(vi), ViConstString(channelName), ViInt32(source))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def ConfigureTriggeredVoltageLevel(self, vi, channelName, level):
        status = self.dll.hpe363xa_ConfigureTriggeredVoltageLevel(
    ...
    def ConfigureTriggeredCurrentLimit(self, vi, channelName, limit):
        status = self.dll.hpe363xa_ConfigureTriggeredCurrentLimit(
    ...
    def Abort(self, vi):
        status = self.dll.hpe363xa_Abort(ViSession(vi))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def Initiate(self, vi):
        status = self.dll.hpe363xa_Initiate(ViSession(vi))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def SendSoftwareTrigger(self, vi):
        status = self.dll.hpe363xa_SendSoftwareTrigger(ViSession(vi))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def Measure(self, vi, channelName, measurementType):
        ...
        status = self.dll.hpe363xa_Measure(
            ViSession(vi),
            ViConstString(channelName),
    ...
    def error_query(self, vi):
        ...
        status = self.dll.hpe363xa_error_query(ViSession(vi), byref(errorCode), errorMessage)
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def error_message(self, vi, errorCode):
        ...
        status = self.dll.hpe363xa_error_message(ViSession(vi), ViStatus(errorCode), errorMessage)
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def GetError(self, vi, bufferSize):
        ...
        status = self.dll.hpe363xa_GetError(ViSession(vi), byref(errorCode), ViInt32(bufferSize), description)
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def ClearError(self, vi):
        status = self.dll.hpe363xa_ClearError(ViSession(vi))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def GetChannelName(self, vi, index, bufferSize):
        ...
        status = self.dll.hpe363xa_GetChannelName(ViSession(vi), ViInt32(index), ViInt32(bufferSize), name)
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def GetNextInterchangeWarning(self, vi, bufferSize):
        ...
        status = self.dll.hpe363xa_GetNextInterchangeWarning(ViSession(vi), ViInt32(bufferSize), warnString)
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def ResetInterchangeCheck(self, vi):
        status = self.dll.hpe363xa_ResetInterchangeCheck(ViSession(vi))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def ClearInterchangeWarnings(self, vi):
        status = self.dll.hpe363xa_ClearInterchangeWarnings(ViSession(vi))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def reset(self, vi):
        status = self.dll.hpe363xa_reset(ViSession(vi))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def ResetWithDefaults(self, vi):
        status = self.dll.hpe363xa_ResetWithDefaults(ViSession(vi))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def Disable(self, vi):
        status = self.dll.hpe363xa_Disable(ViSession(vi))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def InvalidateAllAttributes(self, vi):
        status = self.dll.hpe363xa_InvalidateAllAttributes(ViSession(vi))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def self_test(self, vi):
        ...
        status = self.dll.hpe363xa_self_test(ViSession(vi), byref(selfTestResult), selfTestMessage)
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def revision_query(self, vi):
        ...
        status = self.dll.hpe363xa_revision_query(ViSession(vi), instrumentDriverRevision, firmwareRevision)
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def viWrite(self, vi, buffer, count):
        ...
        returnCount = ViInt64()
        status = self.dll.hpe363xa_viWrite(ViSession(vi), _buffer, ViInt64(count), byref(returnCount))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def viRead(self, vi, bufferSize):
        ...
        returnCount = ViInt64()
        status = self.dll.hpe363xa_viRead(ViSession(vi), ViInt64(bufferSize), buffer, byref(returnCount))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def WriteInstrData(self, vi, writeBuffer):
        status = self.dll.hpe363xa_WriteInstrData(ViSession(vi), ViConstString(writeBuffer))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def ReadInstrData(self, vi, numBytes):
        ...
        bytesRead = ViInt32()
        status = self.dll.hpe363xa_ReadInstrData(ViSession(vi), ViInt32(numBytes), rdBuf, byref(bytesRead))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def GetAttributeViInt32(self, vi, channelName, attribute):
        value = ViInt32()
        status = self.dll.hpe363xa_GetAttributeViInt32(
    ...
    def GetAttributeViReal64(self, vi, channelName, attribute):
        value = ViReal64()
        status = self.dll.hpe363xa_GetAttributeViReal64(
            ViSession(vi), ViConstString(channelName), ViAttr(attribute), byref(value)
        )
        if int(status) < 0:
            raise InstrumentError(status)
    ...
    def GetAttributeViString(self, vi, channelName, attribute, bufSize):
        ...
        status = self.dll.hpe363xa_GetAttributeViString(
            ViSession(vi),
            ViConstString(channelName),
            ViAttr(attribute),
            ViInt32(bufSize),
    ...
    def GetAttributeViSession(self, vi, channelName, attribute):
        value = ViSession()
        status = self.dll.hpe363xa_GetAttributeViSession(
            ViSession(vi), ViConstString(channelName), ViAttr(attribute), byref(value)
        )
        if int(status) < 0:
            raise InstrumentError(status)
    ...
    def GetAttributeViBoolean(self, vi, channelName, attribute):
        value = ViBoolean()
        status = self.dll.hpe363xa_GetAttributeViBoolean(
            ViSession(vi), ViConstString(channelName), ViAttr(attribute), byref(value)
        )
        if int(status) < 0:
            raise InstrumentError(status)
    ...
    def SetAttributeViInt32(self, vi, channelName, attribute, value):
        status = self.dll.hpe363xa_SetAttributeViInt32(
    ...
    def SetAttributeViReal64(self, vi, channelName, attribute, value):
        status = self.dll.hpe363xa_SetAttributeViReal64(
    ...
    def SetAttributeViString(self, vi, channelName, attribute, value):
        status = self.dll.hpe363xa_SetAttributeViString(
            ViSession(vi),
            ViConstString(channelName),
            ViAttr(attribute),
            ViConstString(value),
    ...
    def SetAttributeViSession(self, vi, channelName, attribute, value):
        status = self.dll.hpe363xa_SetAttributeViSession(
    ...
    def SetAttributeViBoolean(self, vi, channelName, attribute, value):
        status = self.dll.hpe363xa_SetAttributeViBoolean(
    ...
    def CheckAttributeViInt32(self, vi, channelName, attribute, value):
        status = self.dll.hpe363xa_CheckAttributeViInt32(
            ViSession(vi), ViConstString(channelName), ViAttr(attribute), ViInt32(value)
        )
        if int(status) < 0:
            raise InstrumentError(status)
    ...
    def CheckAttributeViReal64(self, vi, channelName, attribute, value):
        status = self.dll.hpe363xa_CheckAttributeViReal64(
            ViSession(vi), ViConstString(channelName), ViAttr(attribute), ViReal64(value)
        )
        if int(status) < 0:
            raise InstrumentError(status)
    ...
    def CheckAttributeViString(self, vi, channelName, attribute, value):
        status = self.dll.hpe363xa_CheckAttributeViString(
            ViSession(vi),
            ViConstString(channelName),
            ViAttr(attribute),
            ViConstString(value),
    ...
    def CheckAttributeViSession(self, vi, channelName, attribute, value):
        status = self.dll.hpe363xa_CheckAttributeViSession(
            ViSession(vi), ViConstString(channelName), ViAttr(attribute), ViSession(value)
        )
        if int(status) < 0:
            raise InstrumentError(status)
    ...
    def CheckAttributeViBoolean(self, vi, channelName, attribute, value):
        status = self.dll.hpe363xa_CheckAttributeViBoolean(
            ViSession(vi), ViConstString(channelName), ViAttr(attribute), ViBoolean(value)
        )
        if int(status) < 0:
            raise InstrumentError(status)
    ...
    def IviInit(self, resourceName, IDQuery, reset, vi):
        status = self.dll.hpe363xa_IviInit(ViRsrc(resourceName), ViBoolean(IDQuery), ViBoolean(reset), ViSession(vi))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def IviClose(self, vi):
        status = self.dll.hpe363xa_IviClose(ViSession(vi))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
    ...
    def GetErrorInfo(self, vi):
        ...
        status = self.dll.hpe363xa_GetErrorInfo(
    ...
    def ClearErrorInfo(self, vi):
        status = self.dll.hpe363xa_ClearErrorInfo(ViSession(vi))
        if int(status) < 0:
            raise InstrumentError(status)
        elif int(status) > 0:
            raise InstrumentWarning(status)
