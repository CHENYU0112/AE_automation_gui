...
from .hpe363xa_dllwrap import *


class hpe363xa(IVICDriverWrapper):
    def __init__(self):
        super().__init__()
        self._dllwrap = hpe363xa_dllwrap()
        self._vi = None
        """:type : int"""
    ...
    def ConfigureAllOutputEnabled(self, outputEnabled):
        """

        :param outputEnabled:
        :type outputEnabled:
        """
        return self._dllwrap.ConfigureAllOutputEnabled(self._vi, outputEnabled)
