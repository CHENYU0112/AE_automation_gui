...
from .hp662xa_dllwrap import *


class hp662xa(IVICDriverWrapper):
    def __init__(self):
        super().__init__()
        self._dllwrap = hp662xa_dllwrap()
        self._vi = None
        """:type : int"""
    ...
    def QueryFaultState(self, channelName, outputState):
        """
        ...
        :type outputState:
        """
        return self._dllwrap.QueryFaultState(self._vi, channelName, outputState)

    def QueryAccumulatedState(self, channelName, outputState):
        """
        ...
        :type outputState:
        """
        return self._dllwrap.QueryAccumulatedState(self._vi, channelName, outputState)
