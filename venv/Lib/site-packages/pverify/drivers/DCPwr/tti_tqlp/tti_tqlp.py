...
from .tti_tqlp_dllwrap import *


class tti_tqlp(IVICDriverWrapper):
    def __init__(self):
        super().__init__()
        self._dllwrap = tti_tqlp_dllwrap()
        self._vi = None
        """:type : int"""
    ...
    def ConfigureOCP(self, channelName, limit):
        """
        ...
        :type limit:
        """
        return self._dllwrap.ConfigureOCP(self._vi, channelName, limit)
    ...
    def IncrementVoltageLevel(self, channelName):
        """

        :param channelName:
        :type channelName:
        """
        return self._dllwrap.IncrementVoltageLevel(self._vi, channelName)

    def DecrementVoltageLevel(self, channelName):
        """

        :param channelName:
        :type channelName:
        """
        return self._dllwrap.DecrementVoltageLevel(self._vi, channelName)

    def IncrementCurrentLevel(self, channelName):
        """

        :param channelName:
        :type channelName:
        """
        return self._dllwrap.IncrementCurrentLevel(self._vi, channelName)

    def DecrementCurrentLevel(self, channelName):
        """

        :param channelName:
        :type channelName:
        """
        return self._dllwrap.DecrementCurrentLevel(self._vi, channelName)
    ...
    def GetError(self):
        """"""
        return self._dllwrap.GetError(self._vi)

    def ClearError(self):
        """"""
        return self._dllwrap.ClearError(self._vi)

    def execution_error_query(self):
        """"""
        return self._dllwrap.execution_error_query(self._vi)
    ...
    def WaitForOperationComplete(self):
        """"""
        return self._dllwrap.WaitForOperationComplete(self._vi)
    ...
    def SaveSetup(self, channelName, store):
        """
        ...
        :type store:
        """
        return self._dllwrap.SaveSetup(self._vi, channelName, store)

    def RecallSetup(self, channelName, store):
        """
        ...
        :type store:
        """
        return self._dllwrap.RecallSetup(self._vi, channelName, store)

    def Local(self):
        """"""
        return self._dllwrap.Local(self._vi)
