...
class IIviDCPwrOutput:
    ...
    def VoltageLevel(self, value):
        ...
        """
        self.root.dllwrap.WriteInstrData(f"V{self.channel} {value:.3f}")
    ...
    def CurrentLimit(self, value):
        ...
        """
        self.root.dllwrap.WriteInstrData(f"I{self.channel} {value:.3f}")
    ...
    def OVPLimit(self, value):
        ...
        Volts.
        """
        self.root.dllwrap.WriteInstrData(f"OVP{self.channel} {value:.3f}")
    ...
    def ConfigureCurrentLimit(self, Behavior, Limit):
        ...
        :type Limit: float
        """
        self.CurrentLimitBehavior = Behavior
