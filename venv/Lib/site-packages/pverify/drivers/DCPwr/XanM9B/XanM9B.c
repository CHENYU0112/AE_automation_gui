/*=============================================================================
Copyright 2003-2013 Xantrex Technology, Inc. All rights reserved.
 ...
 *                        in initialize time.
 *
 * 10/25/2013 - [ZW] Port driver to 64-bit.
=============================================================================*/
...
static ViStatus XanM9B_InitAttributes (ViSession vi, ViInt32 modelType)
{
   ...
   ViReal64    maxVoltage = 0, OVPMaxVoltage = 0,OVPMinVoltage = 0,currentLimit = 0;
