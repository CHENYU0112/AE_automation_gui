...
class IIviDriverOperation:
    def __init__(self, parent=None):
        self.parent = parent
        if False:
            from .IIfxPwrAn import IIfxPwrAn

            self.parent = IIfxPwrAn()

    @property
    def LogicalName(self):
        return self.parent.interface.ResourceName

    @LogicalName.setter
    def LogicalName(self, value):
        """
    ...
    @IoResourceDescriptor.setter
    def IoResourceDescriptor(self, value):
        """
        The resource descriptor specifies the connection to a physical device.
        It is either specified in the Configuration Store or passed in the
        ResourceName parameter of the Initialize function.  It is empty if the
    ...
    @DriverSetup.setter
    def DriverSetup(self, value):
        """
        The driver setup string.  It is either specified in the Configuration
        Store or passed in the OptionString parameter of the Initialize
        function.  Driver setup is empty if the driver is not initialized.
        """
        raise NotImplementedError
    ...
    @property
    def NextInterchangeWarning(self):
        """
