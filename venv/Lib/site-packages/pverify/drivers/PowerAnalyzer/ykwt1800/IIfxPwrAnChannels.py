...
from pverify.drivers.PowerAnalyzer.ykwt1800.IIfxPwrAnChannel import IIfxPwrAnChannel
...
class IIfxPwrAnChannels(IIfxPwrAnBase.IIfxPwrAnBase):
    ...
    def __init__(self, parent):
        ...
        self.__channels = {
            ...
            "4": IIfxPwrAnChannel(self, 4),
            "5": IIfxPwrAnChannel(self, 5),
            "6": IIfxPwrAnChannel(self, 6),
    ...
    def Item(self, Name):
        ...
        :param Name: The channel number (1-6)
        :type Name: int
        :rtype: IIfxPwrAnChannel
        """
        if str(Name) in ["1", "2", "3", "4", "5", "6"]:
            return self.__channels[str(Name)]
        else:
            msg = 'ykwt1800: Channel name has to be one of ["1", "2", "3", "4", "5", "6"]'
    ...
    def Name(self, Index):
        ...
        """
        if (int(Index) > 0) and (int(Index) <= 6):
            return ["1", "2", "3", "4", "5", "6"][int(Index) - 1]
        else:
            msg = "ykwt1800: Channel index exceeds the limits 1-6"
            raise IndexError(msg)
