...
from pverify.drivers.PowerAnalyzer.ykwt1800 import (
    IIfxPwrAnBase,
    IIfxPwrAnChannels,
    IIfxPwrAnHarmonics,
...
class IIfxPwrAn(IVICOMDriverWrapper, IIfxPwrAnBase.IIfxPwrAnBase):
    ...
    def Initialize(self, ResourceName, IdQuery=1, Reset=1, OptionString=""):
        ...
        if IdQuery:
            ...
            ret = ret.strip()
            self.IDN = ret
            if ret.find("YOKOGAWA,WT18") == -1:
                warnings.warn(f"ykwt1800: Can't find 'YOKOGAWA,WT18' in the returned IDN string '{ret}'", stacklevel=1)
        ...
        self.interface.vi_write(':MEAS:FUNC5:EXPR "WH(E5)/TI(E5)*3600"')
        self.interface.vi_write(':MEAS:FUNC6:EXPR "WH(E6)/TI(E6)*3600"')
        ...
        self.interface.vi_write(':MEAS:FUNC5:UNIT "W"')
        self.interface.vi_write(':MEAS:FUNC6:UNIT "W"')
        ...
        self.interface.vi_write(":MEAS:FUNC5:STAT ON")
        self.interface.vi_write(":MEAS:FUNC6:STAT ON")
        self.GetError()
