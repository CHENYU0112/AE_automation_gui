...
from pverify.drivers.PowerAnalyzer.ykwt1800.IIfxPwrAnWaveform import IIfxPwrAnWaveform
...
class IIfxPwrAnWaveforms(IIfxPwrAnBase.IIfxPwrAnBase):
    ...
    def Item(self, Source):
        ...
        if Source in [
            ...
            msg = f"Channel '{Source}' does not exist. This power analyzer only has channel 1-6."
    ...
    def Name(self, Index):
        ...
        """
        if (int(Index) >= 1) and (int(Index) <= 6):
            return [
                "U1",
                "U2",
                "U3",
