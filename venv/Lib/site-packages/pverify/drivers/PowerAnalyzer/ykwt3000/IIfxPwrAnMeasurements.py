...
from pverify.drivers.PowerAnalyzer.ykwt3000.IIfxPwrAnMeasurement import IIfxPwrAnMeasurement
...
class IIfxPwrAnMeasurements(IIfxPwrAnBase.IIfxPwrAnBase):
    ...
    def Item(self, Element, PwrAnMeasItem):
        ...
        """
        if (int(Element) >= 1) and (int(Element) <= 4):
            ...
            msg = f"Channel '{Element}' does not exist. This power analyzer only has channel 1-4."
