...
class IIfxPwrAnChannel(IIfxPwrAnBase.IIfxPwrAnBase):
    ...
    def MeasuringMode(self):
        ...
        """
        ret = self.interface.vi_query(":VOLT:MODE:ELEM%d?" % self.Element, rformat="%s")
        self.GetError()
        return self.Enums.enum_from_value(self.Enums.IfxPwrAnMeasuringModeEnum, ret)
    ...
    def MeasuringMode(self, value):
        ...
        """
        self.interface.vi_write(":CURR:MODE:ELEM%d %s" % (self.Element, value.value))
        self.interface.vi_write(":VOLT:MODE:ELEM%d %s" % (self.Element, value.value))
    ...
    def ConfigureChannel(
        ...
        """
        Configures the most commonly used properties of the PwrAn
        channel sub-system. They are the VoltageMeasuringMode,
        VoltageRange, CurrentMeasuringMode, CurrentRange,
