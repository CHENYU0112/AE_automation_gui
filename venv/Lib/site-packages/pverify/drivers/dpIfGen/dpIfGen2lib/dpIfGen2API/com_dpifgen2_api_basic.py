#!/usr/bin/python
# ===========================================================================
# Name:        com_dpifgen2_api_basic.py
#
# Purpose:     Basic API for dpIFGen2 communication
#
...
#
# Dependency: re, com_dpifgen2_api_executer_basic,
#             lib_dpifgen2_commands_list
#
# ===========================================================================
...
""" This Documentation describes the .dp Interface Gen 2(dpIfGen2) board's
    basic API to communicate with the dp2a and dp2b b11 chips. The API is
    meant to serve as an abstraction layer between the PC and the dp2a/dp2b
    b11 chip hiding the unnecessary details in the low level communication
...
class DpIfGen2APIBasic:
    ...
    def dict_of_api_functions():
        return {
            "C1_1:Establish Connection": {
                ...
                "Usage": "DpIfGen2APIBasic.connection_establish(verbose=True, debug=False)",
                "Description": DpIfGen2APIBasic.connection_establish.__doc__,
                "Class": "Connection",
            },
            "C1_2:Set Baudrate": {
                "Name": "Set Baudrate",
                "Usage": 'DpIfGen2APIBasic.baudrate_set("57600", verbose=True, debug=False)',
                "Description": DpIfGen2APIBasic.baudrate_set.__doc__,
                "Class": "Connection",
            },
            "C1_3:Set Sync": {
                "Name": "Set Sync",
                "Usage": "DpIfGen2APIBasic.sync_set(3, verbose=True, debug=False)",
                "Description": DpIfGen2APIBasic.sync_set.__doc__,
                "Class": "Connection",
            },
            "C1_4:Read FW ID": {
                "Name": "Read FW ID",
                "Usage": "fw_id = DpIfGen2APIBasic.interface_fw_id_read(verbose=True, debug=False)",
                "Description": DpIfGen2APIBasic.interface_fw_id_read.__doc__,
                "Class": "Connection",
            },
            "C1_5:Set Voltage Level": {
                "Name": "Set Voltage Level",
                "Usage": "DpIfGen2APIBasic.voltage_level_set(24.5 ,verbose=True, debug=False)",
                "Description": DpIfGen2APIBasic.voltage_level_set.__doc__,
                "Class": "Connection",
            },
            "C1_6:Voltage Cycle": {
                "Name": "Voltage Cycle",
                "Usage": "DpIfGen2APIBasic.voltage_cycle_execute(24, 7.5 ,verbose=True, debug=False)",
                "Description": DpIfGen2APIBasic.voltage_cycle_execute.__doc__,
                "Class": "Connection",
            },
            "C1_7:Select Chip ID": {
                "Name": "Select Chip ID",
                "Usage": 'DpIfGen2APIBasic.chip_id_set("dp2b", verbose=True, debug=False)',
                "Description": DpIfGen2APIBasic.chip_id_set.__doc__,
                "Class": "Connection",
            },
            "C1_8:Set Auto Chip ID": {
                "Name": "Set Auto Chip ID",
                "Usage": "DpIfGen2APIBasic.auto_chip_id_set(verbose=True, debug=False)",
                "Description": DpIfGen2APIBasic.auto_chip_id_set.__doc__,
                "Class": "Connection",
            },
            "C1_9:Identify Chip": {
                "Name": "Identify Chip",
                "Usage": "DpIfGen2APIBasic.chip_identify(verbose=True, debug=False)",
                "Description": DpIfGen2APIBasic.chip_identify.__doc__,
                "Class": "Connection",
            },
            "C2_1:Read Memory": {
                "Name": "Read Memory",
                "Usage": 'output_word = DpIfGen2APIBasic.memory_read("8080", "dec", ' "verbose=True, debug=False)",
                "Description": DpIfGen2APIBasic.memory_read.__doc__,
                "Class": "Read",
            },
            "C2_2:Read Memory Block": {
                "Name": "Read Memory Block",
                "Usage": 'output_data = DpIfGen2APIBasic.memory_block_read("8080", "0010", "hex", '
                "verbose=True, debug=False)",
                "Description": DpIfGen2APIBasic.memory_block_read.__doc__,
                "Class": "Read",
            },
            "C3_1:Write Memory": {
                "Name": "Write Memory",
                "Usage": 'DpIfGen2APIBasic.memory_write("8000", "BEEF", verbose=True, debug=False)',
                "Description": DpIfGen2APIBasic.memory_write.__doc__,
                "Class": "Write",
            },
            "C3_2:Write Memory Block": {
                "Name": "Write Memory Block",
                "Usage": 'DpIfGen2APIBasic.memory_block_write("8080", '
                '["0010", "0089", "0123"], verbose=True, debug=False)',
                "Description": DpIfGen2APIBasic.memory_block_write.__doc__,
                "Class": "Write",
            },
            "C3_3:Write Ahex File": {
                "Name": "Write Ahex File",
                "Usage": 'DpIfGen2APIBasic.ahex_file_write(r"filename.ahex", verbose=True, debug=False)',
                "Description": DpIfGen2APIBasic.ahex_file_write.__doc__,
                "Class": "Write",
            },
            "C3_4:Write Password": {
                "Name": "Write Password",
                "Usage": 'DpIfGen2APIBasic.password_write("DEEDBEAF", verbose=True, debug=False)',
                "Description": DpIfGen2APIBasic.password_write.__doc__,
                "Class": "Write",
            },
            "C4_1:Burn Memory": {
                "Name": "Burn Memory",
                "Usage": 'DpIfGen2APIBasic.memory_burn("8000", "BEEF", verbose=True, debug=False)',
                "Description": DpIfGen2APIBasic.memory_burn.__doc__,
                "Class": "Burn",
            },
            "C4_2:Burn Memory Block": {
                "Name": "Burn Memory Block",
                "Usage": 'DpIfGen2APIBasic.memory_block_burn("8080", '
                '["0010", "0089", "0123"], verbose=True, debug=False)',
                "Description": DpIfGen2APIBasic.memory_block_burn.__doc__,
                "Class": "Burn",
            },
            "C4_3:Burn Ahex File": {
                "Name": "Burn Ahex File",
                "Usage": 'DpIfGen2APIBasic.ahex_file_burn(r"filename.ahex", verbose=True, debug=False)',
                "Description": DpIfGen2APIBasic.ahex_file_burn.__doc__,
                "Class": "Burn",
            },
            "C5_1:Verify CRC": {
                "Name": "Verify CRC",
                "Usage": 'verified = DpIfGen2APIBasic.crc_verify("8000", "0010", "BEEF", verbose=True, debug=False)',
                "Description": DpIfGen2APIBasic.crc_verify.__doc__,
                "Class": "Check",
            },
            "C5_2:Blank Check": {
                "Name": "Blank Check",
                "Usage": 'memory_blank = DpIfGen2APIBasic.memory_block_check_blank("8080", "0010", '
                "verbose=True, debug=False)",
                "Description": DpIfGen2APIBasic.memory_block_check_blank.__doc__,
                "Class": "Check",
            },
            "C6_1:Execute Jump": {
                "Name": "Execute Jump",
                "Usage": 'DpIfGen2APIBasic.jump_execute("8000", verbose=True, debug=False)',
                "Description": DpIfGen2APIBasic.jump_execute.__doc__,
                "Class": "Others",
            },
            "C6_2:Execute Call": {
                "Name": "Execute Call",
                "Usage": 'DpIfGen2APIBasic.call_execute("8000", verbose=True, debug=False)',
                "Description": DpIfGen2APIBasic.call_execute.__doc__,
                "Class": "Others",
            },
            "C6_3:Calculate CRC": {
                "Name": "Calculate CRC",
                "Usage": 'crc = DpIfGen2APIBasic.crc_calculate("8080", "0010", "hex", ' "verbose=True, debug=False)",
                "Description": DpIfGen2APIBasic.crc_calculate.__doc__,
                "Class": "Others",
            },
            "C6_4:Get Information": {
                "Name": "Get Information",
                "Usage": "info = DpIfGen2APIBasic.info_get(verbose=True, debug=False)",
                "Description": DpIfGen2APIBasic.info_get.__doc__,
                "Class": "Others",
            },
        }
    ...
    def connection_establish(verbose=False, debug=False, parent=None):
        ...
        >>> DpIfGen2APIBasic.connection_establish(verbose=True)

        """
        DpIfGen2APIBasic.baudrate_set("57600", verbose, debug)
        DpIfGen2APIBasic.voltage_cycle_execute(24, 7.5, verbose, debug)
        DpIfGen2APIBasic.sync_set(3, verbose, debug)
        DpIfGen2APIBasic.auto_chip_id_set(verbose, debug)
    ...
    def baudrate_set(baudrate, verbose=False, debug=False, parent=None):
        ...
        >>> DpIfGen2APIBasic.baudrate_set("57600")
        >>> DpIfGen2APIBasic.baudrate_set("57600", verbose=True)
    ...
    def sync_set(num_tries=3, verbose=False, debug=False, parent=None):
        ...
        >>> DpIfGen2APIBasic.sync_set(3)
        >>> DpIfGen2APIBasic.sync_set(3, verbose=True)
        """
        num_tries = f"{num_tries:04X}"
        num_tries_endian = DpIfGen2APIBasic.convert_endian(num_tries)
    ...
    def interface_fw_id_read(verbose=False, debug=False, parent=None):
        ...
        >>> fw_id = DpIfGen2APIBasic.interface_fw_id_read()
        >>> fw_id = DpIfGen2APIBasic.interface_fw_id_read(verbose=True)
        """
        # define the sequence
        exec_seq = {}
        ...
        return DpIfGen2APIBasic.exec_config_seq(exec_seq, verbose, debug, parent)
    ...
    def voltage_level_set(v_level, verbose=False, debug=False, parent=None):
        ...
        >>> DpIfGen2APIBasic.voltage_level_set(24.5)
        >>> DpIfGen2APIBasic.voltage_level_set(24.5 ,verbose=True)
        """
        voltage = f"{v_level:.1f}"
        voltage_dec = int(float(voltage) * 10)
        voltage_hex = f"{voltage_dec:04X}"
        voltage_endian = DpIfGen2APIBasic.convert_endian(voltage_hex)
    ...
    def voltage_cycle_execute(v_level1, v_level2, verbose=False, debug=False, parent=None):
        ...
        >>> DpIfGen2APIBasic.voltage_cycle_execute(24, 7.5)
        >>> DpIfGen2APIBasic.voltage_cycle_execute(24, 7.5 ,verbose=True)
        """
        voltage1 = f"{v_level1:.1f}"
        voltage1_dec = int(float(voltage1) * 10)
        voltage1_hex = f"{voltage1_dec:04X}"
        voltage1_endian = DpIfGen2APIBasic.convert_endian(voltage1_hex)

        voltage2 = f"{v_level2:.1f}"
        voltage2_dec = int(float(voltage2) * 10)
        voltage2_hex = f"{voltage2_dec:04X}"
        voltage2_endian = DpIfGen2APIBasic.convert_endian(voltage2_hex)
    ...
    @staticmethod
    def auto_chip_id_set(verbose=False, debug=False, parent=None):
        ...
        >>> DpIfGen2APIBasic.auto_chip_id_set()
        >>> DpIfGen2APIBasic.auto_chip_id_set(verbose=True)
        """
        parameter = ""
        # define the sequence
        exec_seq = {}
    ...
    @staticmethod
    def chip_id_set(chip_id, verbose=False, debug=False, parent=None):
        ...
        >>> DpIfGen2APIBasic.chip_id_set("dp2b")
        >>> DpIfGen2APIBasic.chip_id_set("dp2b", verbose=True)
        """
    ...
    def chip_identify(verbose=False, debug=False, parent=None):
        ...
        >>> chip_id = DpIfGen2APIBasic.chip_identify()
        >>> chip_id = DpIfGen2APIBasic.chip_identify(verbose=True)
        """
        # define the sequence
        exec_seq = {}
        ...
        status = DpIfGen2APIBasic.exec_config_seq(exec_seq, verbose, debug, parent)
        chip_id = None
        if status:
            if status & 0x0002:
                chip_id = "dp25"
    ...
    def memory_read(address, out_format="hex", verbose=False, debug=False, parent=None):
        ...
        >>> output_word = DpIfGen2APIBasic.memory_read("8080")
        >>> output_word = DpIfGen2APIBasic.memory_read("8080", "dec", verbose=True)
        """
    ...
    def memory_block_read(address, length, out_format="hex", verbose=False, debug=False, parent=None):
        ...
        >>> output_data = DpIfGen2APIBasic.memory_block_read("8080", "0010")
        >>> output_data = DpIfGen2APIBasic.memory_block_read("8080", "0010", "hex", verbose=True)
        """
        ...
        mem_block = DpIfGen2APIBasic.exec_config_seq(exec_seq, verbose, debug, parent)
    ...
    def memory_write(address, value, verbose=False, debug=False, parent=None):
        ...
        >>> DpIfGen2APIBasic.memory_write("8000", "BEEF")
        >>> DpIfGen2APIBasic.memory_write("8000", "BEEF", verbose=True)
    ...
    def memory_block_write(address, data, verbose=False, debug=False, parent=None):
        ...
        >>> DpIfGen2APIBasic.memory_block_write("8080", ["0010", "0089", "0123"])
        >>> DpIfGen2APIBasic.memory_block_write("8080", ["0010", "0089", "0123"], verbose=True)
        """
    ...
    def ahex_file_write(filename, verbose=False, debug=False, parent=None):
        ...
        >>> DpIfGen2APIBasic.ahex_file_write(r"filename.ahex")
        >>> DpIfGen2APIBasic.ahex_file_write(r"filename.ahex", verbose=True)
    ...
    @staticmethod
    def password_write(password, verbose=False, debug=False, parent=None):
        ...
        >>> DpIfGen2APIBasic.password_write("DEEDBEAF")
        >>> DpIfGen2APIBasic.password_write("DEEDBEAF", verbose=True)
        """
        ...
        parameter1 = DpIfGen2APIBasic.convert_endian(password_high)
        parameter2 = DpIfGen2APIBasic.convert_endian(password_low)
        # define the sequence
        exec_seq = {}
    ...
    def memory_burn(address, value, verbose=False, debug=False, parent=None):
        ...
        .. warning::
            Make sure that VCC is exactly 7.5V when conducting burning.
            This command only works with unlocked chips.

        Example Usage:

        >>> DpIfGen2APIBasic.memory_burn("8000", "BEEF")
        >>> DpIfGen2APIBasic.memory_burn("8000", "BEEF", verbose=True)
        """
        address_chk = re.match(r"([0-9a-fA-F]{4})", address)
        if not address_chk:
            msg = "Address is not in correct format. Please enter a 4 Hexadecimal digit Address"
    ...
    def memory_block_burn(address, data, verbose=False, debug=False, parent=None):
        ...
        """
        DpIfGen2APIBasic.memory_block_write(address, data, verbose, debug, parent)
    ...
    def ahex_file_burn(filename, verbose=False, debug=False, parent=None):
        ...
        >>> DpIfGen2APIBasic.ahex_file_burn(r"filename.ahex")
        >>> DpIfGen2APIBasic.ahex_file_burn(r"filename.ahex", verbose=True)
        """

        DpIfGen2APIBasic.ahex_file_write(filename, verbose, debug, parent)
    ...
    @staticmethod
    def crc_verify(address, length, crc, verbose=False, debug=False, parent=None):
        ...
        address_endian = DpIfGen2APIBasic.convert_endian(address)
        length_endian = DpIfGen2APIBasic.convert_endian(length)
        crc_endian = DpIfGen2APIBasic.convert_endian(crc)
    ...
    def memory_block_check_blank(address, length, verbose=False, debug=False, parent=None):
        ...
        >>> memory_blank = DpIfGen2APIBasic.memory_block_check_blank("8080", "0010")
        >>> memory_blank = DpIfGen2APIBasic.memory_block_check_blank("8080", "0010", verbose=True)
        """
        address_chk = re.match(r"([0-9a-fA-F]{4})", address)
        if not address_chk:
            msg = "Address is not in correct format. Please enter a 4 Hexadecimal digit Address"
    ...
    def jump_execute(address, verbose=False, debug=False, parent=None):
        ...
        >>> DpIfGen2APIBasic.jump_execute("8000")
        >>> DpIfGen2APIBasic.jump_execute("8000", verbose=True)
        """
        address_chk = re.match(r"([0-9a-fA-F]{4})", address)
        if not address_chk:
            msg = "Address is not in correct format. Please enter a 4 Hexadecimal digit Address"
    ...
    def call_execute(address, verbose=False, debug=False, parent=None):
        ...
        >>> DpIfGen2APIBasic.call_execute("8000")
        >>> DpIfGen2APIBasic.call_execute("8000", verbose=True)
        """
        address_chk = re.match(r"([0-9a-fA-F]{4})", address)
        if not address_chk:
            msg = "Address is not in correct format. Please enter a 4 Hexadecimal digit Address"
    ...
    def info_get(verbose=False, debug=False, parent=None):
        ...
        >>> info = DpIfGen2APIBasic.info_get()
        >>> info = DpIfGen2APIBasic.info_get(verbose=True)
        """
        ...
        if verbose:
            ...
            DpIfGen2APIBasic.display_msg(msg)
        ROM_VERSION_DICT = {
            0xB01: "DP2B A11",
            0xB02: "DP2B B11",
            0x101: "DP2A-A11",
        ...
        ROM_VERSION_LEN = 1
        rom_version = DpIfGen2APIBasic.memory_block_read(ROM_VERSION_LOC, ROM_VERSION_LEN, "dict", debug, False)
        ...
        if debug:
            for key in sorted(rom_version.keys()):
                DpIfGen2APIBasic.display_msg("".join([key, ":", rom_version[key]]))
    ...
    @staticmethod
    def crc_calculate(address, length, verbose=False, debug=False, parent=None):
        ...
        >>> crc = DpIfGen2APIBasic.crc_calculate("8080", "0010")
        >>> crc = DpIfGen2APIBasic.crc_calculate("8080", "0010", verbose=True)
        """
        ...
        crc = DpIfGen2APIBasic.exec_config_seq(exec_seq, verbose, debug, parent)
    ...
    def exec_config_seq(exec_seq, verbose=False, debug=False, parent=None):
        try:
            if verbose:
                msg = "".join(["Executing Sequence ", exec_seq.get("Name")])
                DpIfGen2APIBasic.display_msg(msg, parent)
            ...
            # decode error string
            decoded = DpIfGen2APIBasic.decode_error_code(str(e))
            if decoded:
...
def main():
    ...
    print("Version", DpIfGen2APIBasic.VERSION)

    # DpIfGen2APIBasic.baudrate_set('57600', True, False)
    DpIfGen2APIBasic.connection_establish(True, False)
    # DpIfGen2APIBasic.sync_set(10, True, False)

    # DpIfGen2APIBasic.voltage_level_set(27.5, True, False)
    # DpIfGen2APIBasic.voltage_cycle_execute(27.5, 8.5, True, False)
    # DpIfGen2APIBasic.chip_id_set("dp2a", True, False)
    info = DpIfGen2APIBasic.info_get(verbose=True, debug=False)
    print(info)
    DpIfGen2APIBasic.memory_block_write("8000", ["0000", "0001", "0002", 3, 4, "0005"], True, False)
    read_back = DpIfGen2APIBasic.memory_block_read("8000", 6, "hex", True, False)
    print(read_back)
    print(DpIfGen2APIBasic.memory_block_check_blank("8000", "0010", True, False))
    func_dict = DpIfGen2APIBasic.dict_of_api_functions()
    print(func_dict)


##    DpIfGen2APIBasic.interface_fw_id_read(True, False)
##    DpIfGen2APIBasic.memory_write("9C00","BEEF", True, False)
##    DpIfGen2APIBasic.memory_block_write("dump.ahex", True, False)
##    DpIfGen2APIBasic.password_write("548DE563", True, False)
##    print(DpIfGen2APIBasic.memory_read("9C00", "hex", True, False))
##    DpIfGen2APIBasic.memory_burn("C347", "BAAF", True, False)
##    DpIfGen2APIBasic.memory_block_burn("dump.otp.ahex", True, False)
##    print(DpIfGen2APIBasic.memory_read("C348", "hex", True, False))
##    print(DpIfGen2APIBasic.memory_read("C349", "hex", True, False))
##    DpIfGen2APIBasic.crc_verify("C348", "0002", "2737", True)
##    DpIfGen2APIBasic.memory_block_check_blank("c34D","0002", True)
##    DpIfGen2APIBasic.jump_execute("8000", True)
##    DpIfGen2APIBasic.call_execute("8000", True)
##    print(DpIfGen2APIBasic.memory_block_read("9C00", "1000", "hex", True, False))
##    print(DpIfGen2APIBasic.memory_read("C347", "hex", True, False))
