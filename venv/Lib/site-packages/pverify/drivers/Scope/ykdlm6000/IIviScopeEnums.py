...
class IviScopeAcquisitionTypeEnum(Enum):
    ...
    IviScopeAcquisitionTypeNormal = "NORM"
    # IviScopeAcquisitionTypePeakDetect = ""
    IviScopeAcquisitionTypeHiRes = "HighRes"
    IviScopeAcquisitionTypeEnvelope = "ENV"
    IviScopeAcquisitionTypeAverage = "AVER"


class IviScopeVerticalCouplingEnum(Enum):
    """IVI Scope class-compliant values for channel Coupling."""

    IviScopeVerticalCouplingAC = "AC"
    IviScopeVerticalCouplingDC = "DC"
    IviScopeVerticalCouplingGnd = "GND"
...
class IviScopeMeasurementEnum(Enum):
    ...
    IviScopeMeasurementVoltageCycleAverage = "CME"
...
class IviScopeAcquisitionStatusEnum(Enum):
    ...
    IviScopeAcqInProgress = 1
    IviScopeAcqComplete = 0
...
class IviScopeTriggerTypeEnum(Enum):
    ...
    IviScopeTriggerWidth = "PULS"
    # IviScopeTriggerRunt = ""
    IviScopeTriggerGlitch = "PULS"
    # IviScopeTriggerTV = "TV"
...
class IviScopeTriggerModifierEnum(Enum):
    ...
    IviScopeTriggerModifierNone = "NORM"
    IviScopeTriggerModifierAuto = "AUTO"
    IviScopeTriggerModifierAutoLevel = "ALEV"
...
class IviScopeTriggerSlopeEnum(Enum):
    ...
    IviScopeTriggerSlopeNegative = "FALL"
    IviScopeTriggerSlopePositive = "RISE"
    # For window triggering
    IviScopeTriggerSlopeEnter = "ENT"
    IviScopeTriggerSlopeLeave = "EXIT"


class IviScopeGlitchPolarityEnum(Enum):
    """IVI Scope class-compliant values for glitch trigger Polarity."""

    IviScopeGlitchPolarityPositive = "POS"
    IviScopeGlitchPolarityNegative = "NEG"
...
class IviScopeGlitchConditionEnum(Enum):
    ...
    IviScopeGlitchConditionLessThan = "IN"
    IviScopeGlitchConditionGreaterThan = "OUT"
...
class IviScopeWidthPolarityEnum(Enum):
    ...
    IviScopeWidthPolarityPositive = "POS"
    IviScopeWidthPolarityNegative = "NEG"
    # For window triggering
    # IviScopeWidthPolarityEnter = "IN"
    # IviScopeWidthPolarityLeave = "OUT"
...
class IviScopeWidthConditionEnum(Enum):
    ...
    IviScopeWidthConditionWithin = "BETW"
    IviScopeWidthConditionOutside = "NOTB"
    # Additional
    IviScopeWidthConditionTimeout = "TIM"
...
class IviScopeTriggerHysteresisEnum(Enum):
    ...
    IviScopeTriggerHysteresisLow = "LOW"
    IviScopeTriggerHysteresisHigh = "HIGH"
...
class IviScopeTriggerHFRejectionEnum(Enum):
    ...
    IviScopeTriggerHFRejectionOff = "OFF"
    IviScopeTriggerHFRejection15kHz = "15000"
    IviScopeTriggerHFRejection20MHz = "20000000"
