...
class IIviScopeMeasurement:
    ...
    def FetchWaveform(self):
        ...
        (
            ...
            InitialX,
            XIncrement,
        ) = self.root.dllwrap.FetchWaveform(self.channel, size)
    ...
    def FetchWaveformMinMax(self):
        ...
        (
            ...
            InitialX,
            XIncrement,
        ) = self.root.dllwrap.FetchMinMaxWaveform(self.channel, size)
    ...
    def ReadWaveform(self, MaxTimeMilliseconds):
        ...
        (
            ...
            InitialX,
            XIncrement,
        ) = self.root.dllwrap.ReadWaveform(self.channel, size, MaxTimeMilliseconds)
        data = np_array(WaveformArray)[:ActualPoints]
        return data, InitialX, XIncrement
    ...
    def ReadWaveformMinMax(self, MaxTimeMilliseconds):
        ...
        (
            ...
            InitialX,
            XIncrement,
        ) = self.root.dllwrap.FetchMinMaxWaveform(self.channel, size, MaxTimeMilliseconds)
        midata = np_array(MinWaveform)[:ActualPoints]
        madata = np_array(MaxWaveform)[:ActualPoints]
        return midata, madata, InitialX, XIncrement
