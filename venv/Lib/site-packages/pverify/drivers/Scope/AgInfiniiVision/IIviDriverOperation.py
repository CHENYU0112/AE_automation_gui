...
from .AgInfiniiVision import *


class IIviDriverOperation:
    def __init__(self, root):
        self.root = root
        """:type : pverify.drivers.Scope.AgInfiniiVision.IIviScope.IIviScope"""

    @property
    def LogicalName(self):
        return self.root.dllwrap.GetAttributeViString(None, IVI_ENGINE_PUBLIC_ATTR_BASE + 305, 1024)

    @property
    def IoResourceDescriptor(self):
        return self.root.dllwrap.GetAttributeViString(None, IVI_ENGINE_PUBLIC_ATTR_BASE + 304, 1024)

    @property
    def Cache(self):
        return self.root.dllwrap.GetAttributeViBoolean(None, IVI_ENGINE_PUBLIC_ATTR_BASE + 4)
    ...
    def Cache(self, value):
        ...
        instrument settings.
        """
        self.root.dllwrap.SetAttributeViBoolean(None, IVI_ENGINE_PUBLIC_ATTR_BASE + 4, value)

    @property
    def InterchangeCheck(self):
        return self.root.dllwrap.GetAttributeViBoolean(None, IVI_ENGINE_PUBLIC_ATTR_BASE + 21)
    ...
    def InterchangeCheck(self, value):
        ...
        """
        self.root.dllwrap.SetAttributeViBoolean(None, IVI_ENGINE_PUBLIC_ATTR_BASE + 21, value)

    @property
    def QueryInstrumentStatus(self):
        return self.root.dllwrap.GetAttributeViBoolean(None, IVI_ENGINE_PUBLIC_ATTR_BASE + 3)
    ...
    def QueryInstrumentStatus(self, value):
        ...
        from the instrument.
        """
        self.root.dllwrap.SetAttributeViBoolean(None, IVI_ENGINE_PUBLIC_ATTR_BASE + 3, value)

    @property
    def RangeCheck(self):
        return self.root.dllwrap.GetAttributeViBoolean(None, IVI_ENGINE_PUBLIC_ATTR_BASE + 2)
    ...
    def RangeCheck(self, value):
        ...
        """
        self.root.dllwrap.SetAttributeViBoolean(None, IVI_ENGINE_PUBLIC_ATTR_BASE + 2, value)

    @property
    def RecordCoercions(self):
        return self.root.dllwrap.GetAttributeViBoolean(None, IVI_ENGINE_PUBLIC_ATTR_BASE + 6)
    ...
    def RecordCoercions(self, value):
        ...
        return an error.
        """
        self.root.dllwrap.SetAttributeViBoolean(None, IVI_ENGINE_PUBLIC_ATTR_BASE + 6, value)

    @property
    def Simulate(self):
        return self.root.dllwrap.GetAttributeViBoolean(None, IVI_ENGINE_PUBLIC_ATTR_BASE + 5)
    ...
    def Simulate(self, value):
        ...
        """
        self.root.dllwrap.SetAttributeViBoolean(None, IVI_ENGINE_PUBLIC_ATTR_BASE + 5, value)

    @property
    def DriverSetup(self):
        return self.root.dllwrap.GetAttributeViString(None, IVI_ENGINE_PUBLIC_ATTR_BASE + 7, 1024)

    def InvalidateAllAttributes(self):
        """
        Invalidates all of the driver's cached values.
        """
        self.root.dllwrap.InvalidateAllAttributes()
    ...
    def ClearInterchangeWarnings(self):
        ...
        driver maintains.
        """
        self.root.dllwrap.ClearInterchangeWarnings()
    ...
    def GetNextInterchangeWarning(self):
        ...
        """
        return self.root.dllwrap.GetNextInterchangeWarning(1024)
    ...
    def ResetInterchangeCheck(self):
        ...
        """
        self.root.dllwrap.ResetInterchangeCheck()
    ...
    def GetNextCoercionRecord(self):
        ...
        """
        return self.root.dllwrap.GetNextCoercionRecord(1024)
