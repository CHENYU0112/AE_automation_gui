...
class IIviScopeAcquisition:
    ...
    def NumberOfAverages(self):
        return self.root.dllwrap.GetAttributeViInt32(None, IVI_CLASS_PUBLIC_ATTR_BASE + 104)
    ...
    def NumberOfAverages(self, value):
        ...
        to the idle state.
        """
        self.root.dllwrap.SetAttributeViInt32(None, IVI_CLASS_PUBLIC_ATTR_BASE + 104, value)

    @property
    def NumberOfEnvelopes(self):
        return self.root.dllwrap.GetAttributeViInt32(None, IVI_CLASS_PUBLIC_ATTR_BASE + 105)
    ...
    def NumberOfEnvelopes(self, value):
        ...
        """
        self.root.dllwrap.SetAttributeViInt32(None, IVI_CLASS_PUBLIC_ATTR_BASE + 105, value)

    @property
    def Interpolation(self):
        return self.root.dllwrap.GetAttributeViInt32(None, IVI_CLASS_PUBLIC_ATTR_BASE + 19)
    ...
    def Interpolation(self, value):
        ...
        """
        self.root.dllwrap.SetAttributeViInt32(None, IVI_CLASS_PUBLIC_ATTR_BASE + 19, value)

    @property
    def RecordLength(self):
        return self.root.dllwrap.GetAttributeViInt32(None, IVI_CLASS_PUBLIC_ATTR_BASE + 8)

    @property
    def SampleMode(self):
        return self.root.dllwrap.GetAttributeViInt32(None, IVI_CLASS_PUBLIC_ATTR_BASE + 106)

    @property
    def SampleRate(self):
        return self.root.dllwrap.GetAttributeViReal64(None, IVI_CLASS_PUBLIC_ATTR_BASE + 10)

    @property
    def Type(self):
        return self.root.dllwrap.GetAttributeViInt32(None, IVI_CLASS_PUBLIC_ATTR_BASE + 101)
    ...
    def Type(self, value):
        ...
        waveforms.
        """
        self.root.dllwrap.SetAttributeViInt32(None, IVI_CLASS_PUBLIC_ATTR_BASE + 101, value)

    @property
    def NumberOfPointsMin(self):
        return self.root.dllwrap.GetAttributeViInt32(None, IVI_CLASS_PUBLIC_ATTR_BASE + 9)
    ...
    def NumberOfPointsMin(self, value):
        ...
        """
        self.root.dllwrap.SetAttributeViInt32(None, IVI_CLASS_PUBLIC_ATTR_BASE + 9, value)

    @property
    def StartTime(self):
        return self.root.dllwrap.GetAttributeViReal64(None, IVI_CLASS_PUBLIC_ATTR_BASE + 109)
    ...
    def StartTime(self, value):
        ...
        before the trigger.
        """
        self.root.dllwrap.SetAttributeViReal64(None, IVI_CLASS_PUBLIC_ATTR_BASE + 109, value)
    ...
    def ConfigureRecord(self, TimePerRecord, MinNumPts, AcquisitionStartTime):
        ...
        """
        self.root.dllwrap.ConfigureAcquisitionRecord(TimePerRecord, MinNumPts, AcquisitionStartTime)
