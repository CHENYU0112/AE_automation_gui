...
class IIviScopeTriggerGlitch:
    ...
    @property
    def condition(self):
        return self.root.dllwrap.GetAttributeViInt32(None, IVI_CLASS_PUBLIC_ATTR_BASE + 403)
    ...
    def condition(self, value):
        ...
        """
        self.root.dllwrap.SetAttributeViInt32(None, IVI_CLASS_PUBLIC_ATTR_BASE + 403, value)

    @property
    def polarity(self):
        return self.root.dllwrap.GetAttributeViInt32(None, IVI_CLASS_PUBLIC_ATTR_BASE + 402)
    ...
    def polarity(self, value):
        ...
        """
        self.root.dllwrap.SetAttributeViInt32(None, IVI_CLASS_PUBLIC_ATTR_BASE + 402, value)

    @property
    def Width(self):
        return self.root.dllwrap.GetAttributeViReal64(None, IVI_CLASS_PUBLIC_ATTR_BASE + 401)
    ...
    def Width(self, value):
        ...
        """
        self.root.dllwrap.SetAttributeViReal64(None, IVI_CLASS_PUBLIC_ATTR_BASE + 401, value)
    ...
    def Configure(self, Source, Level, Width, polarity, condition):
        ...
        """
        self.root.dllwrap.ConfigureGlitchTriggerSource(Source, Level, Width, polarity, condition)
