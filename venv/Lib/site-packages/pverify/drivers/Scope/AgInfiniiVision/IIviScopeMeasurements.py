...
from .IIviScopeMeasurement import IIviScopeMeasurement
...
class IIviScopeMeasurements:
    def __init__(self, root):
        ...
        """:type : dict[str,IIviScopeMeasurement]"""
    ...
    def Initiate(self):
        ...
        channel.
        """
        self.root.dllwrap.InitiateAcquisition()
    ...
    def Status(self):
        ...
        :rtype: int
        """
        return self.root.dllwrap.AcquisitionStatus()
    ...
    def IsWaveformElementInvalid(self, Element):
        ...
        :rtype: bool
        """
        return self.root.dllwrap.IsInvalidWfmElement(Element)
    ...
    def Item(self, Name):
        ...
        :return: A pointer to a class-compliant IIviScopeMeasurement interface.
        ...
        if self.__channels is None:
            ...
            for i in range(self.Count):
                name = self.Name(i + 1)
                self.__channels.update({name: IIviScopeMeasurement(self.root, name)})
