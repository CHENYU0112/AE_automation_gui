...
class IIviScopeTriggerRunt:
    ...
    @property
    def polarity(self):
        return self.root.dllwrap.GetAttributeViInt32(None, IVI_CLASS_PUBLIC_ATTR_BASE + 303)
    ...
    def polarity(self, value):
        ...
        """
        self.root.dllwrap.SetAttributeViInt32(None, IVI_CLASS_PUBLIC_ATTR_BASE + 303, value)

    @property
    def ThresholdHigh(self):
        return self.root.dllwrap.GetAttributeViReal64(None, IVI_CLASS_PUBLIC_ATTR_BASE + 301)
    ...
    def ThresholdHigh(self, value):
        ...
        volts.
        """
        self.root.dllwrap.SetAttributeViReal64(None, IVI_CLASS_PUBLIC_ATTR_BASE + 301, value)

    @property
    def ThresholdLow(self):
        return self.root.dllwrap.GetAttributeViReal64(None, IVI_CLASS_PUBLIC_ATTR_BASE + 302)
    ...
    def ThresholdLow(self, value):
        ...
        volts.
        """
        self.root.dllwrap.SetAttributeViReal64(None, IVI_CLASS_PUBLIC_ATTR_BASE + 302, value)
    ...
    def Configure(self, Source, ThresholdLow, ThresholdHigh, polarity):
        ...
        """
        self.root.dllwrap.ConfigureRuntTriggerSource(Source, ThresholdLow, ThresholdHigh, polarity)
