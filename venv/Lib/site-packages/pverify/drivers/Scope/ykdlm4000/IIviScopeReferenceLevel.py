...
class IIviScopeReferenceLevel(IIviScopeBase.IIviScopeBase):
    ...
    Methods:
        Configure(Low, Mid, High, *Mode, *AffectedChannels=[])
        ...
        if Mode.upper() == "PERCENT":
            if AffectedChannels:
                for chan in AffectedChannels:
                    self.interface.vi_write(":MEAS:CHAN%s:DPR:MODE PERC;PERC %d,%d,%d" % (int(chan), Low, Mid, High))
            else:
                self.interface.vi_write(":MEAS:CHAN1:DPR:MODE PERC;PERC %d,%d,%d" % (Low, Mid, High))
                self.interface.vi_write(":MEAS:CHAN2:DPR:MODE PERC;PERC %d,%d,%d" % (Low, Mid, High))
                self.interface.vi_write(":MEAS:CHAN3:DPR:MODE PERC;PERC %d,%d,%d" % (Low, Mid, High))
                self.interface.vi_write(":MEAS:CHAN4:DPR:MODE PERC;PERC %d,%d,%d" % (Low, Mid, High))
                self.interface.vi_write(":MEAS:CHAN5:DPR:MODE PERC;PERC %d,%d,%d" % (Low, Mid, High))
                self.interface.vi_write(":MEAS:CHAN6:DPR:MODE PERC;PERC %d,%d,%d" % (Low, Mid, High))
                self.interface.vi_write(":MEAS:CHAN7:DPR:MODE PERC;PERC %d,%d,%d" % (Low, Mid, High))
                self.interface.vi_write(":MEAS:CHAN8:DPR:MODE PERC;PERC %d,%d,%d" % (Low, Mid, High))
                self.interface.vi_write(":MEAS:MATH1:DPR:MODE PERC;PERC %d,%d,%d" % (Low, Mid, High))
                self.interface.vi_write(":MEAS:MATH2:DPR:MODE PERC;PERC %d,%d,%d" % (Low, Mid, High))
                self.interface.vi_write(":MEAS:MATH3:DPR:MODE PERC;PERC %d,%d,%d" % (Low, Mid, High))
                self.interface.vi_write(":MEAS:MATH4:DPR:MODE PERC;PERC %d,%d,%d" % (Low, Mid, High))

        elif Mode.upper() == "UNIT":
            if AffectedChannels:
                for chan in AffectedChannels:
                    self.interface.vi_write(f":MEAS:CHAN{int(chan)}:DPR:MODE UNIT;UNIT {Low:f},{Mid:f},{High:f}")
            else:
                self.interface.vi_write(f":MEAS:CHAN1:DPR:MODE UNIT;UNIT {Low:f},{Mid:f},{High:f}")
                self.interface.vi_write(f":MEAS:CHAN2:DPR:MODE UNIT;UNIT {Low:f},{Mid:f},{High:f}")
                self.interface.vi_write(f":MEAS:CHAN3:DPR:MODE UNIT;UNIT {Low:f},{Mid:f},{High:f}")
                self.interface.vi_write(f":MEAS:CHAN4:DPR:MODE UNIT;UNIT {Low:f},{Mid:f},{High:f}")
                self.interface.vi_write(f":MEAS:CHAN5:DPR:MODE UNIT;UNIT {Low:f},{Mid:f},{High:f}")
                self.interface.vi_write(f":MEAS:CHAN6:DPR:MODE UNIT;UNIT {Low:f},{Mid:f},{High:f}")
                self.interface.vi_write(f":MEAS:CHAN7:DPR:MODE UNIT;UNIT {Low:f},{Mid:f},{High:f}")
                self.interface.vi_write(f":MEAS:CHAN8:DPR:MODE UNIT;UNIT {Low:f},{Mid:f},{High:f}")
                self.interface.vi_write(f":MEAS:MATH1:DPR:MODE UNIT;UNIT {Low:f},{Mid:f},{High:f}")
                self.interface.vi_write(f":MEAS:MATH2:DPR:MODE UNIT;UNIT {Low:f},{Mid:f},{High:f}")
                self.interface.vi_write(f":MEAS:MATH3:DPR:MODE UNIT;UNIT {Low:f},{Mid:f},{High:f}")
                self.interface.vi_write(f":MEAS:MATH4:DPR:MODE UNIT;UNIT {Low:f},{Mid:f},{High:f}")
