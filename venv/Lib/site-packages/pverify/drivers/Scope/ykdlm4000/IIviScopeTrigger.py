...
from pverify.drivers.Scope.ykdlm4000 import (
    IIviScopeBase,
...
class IIviScopeTrigger(IIviScopeBase.IIviScopeBase):
    ...
    def __init__(self, parent):
        ...
        self.parent: IIviScope = parent
        IIviScopeBase.IIviScopeBase.__init__(self, self.parent.interface)

        self.Edge = IIviScopeTriggerEdge.IIviScopeTriggerEdge(self.interface, self)
        self.Glitch = IIviScopeTriggerGlitch.IIviScopeTriggerGlitch(self.interface, self)
        self.Width = IIviScopeTriggerWidth.IIviScopeTriggerWidth(self.interface, self)
    ...
    def Coupling(self):
        ...
        """
        ret = self.interface.vi_query(":TRIG:SIMP:COUP?", rformat="%s")
        self.GetError()
    ...
    def Coupling(self, value):
        ...
        """
        self.interface.vi_write(f":TRIG:SIMP:COUP {value.value}")
        self.GetError()
    ...
    def Level(self):
        ...
        :rtype: float
        """
        ret = self.interface.vi_query(":TRIG:SIMP:LEV?", rformat="%f\n")
        self.GetError()
        return ret
    ...
    def Level(self, value):
        ...
        :type value: float
        """
        self.interface.vi_write(f":TRIG:SIMP:LEV {value:.3E}")
        self.GetError()
    ...
    def Source(self):
        ...
        :rtype: int
        """
        self._source = self.interface.vi_query(":TRIG:SIMP:SOUR?", rformat="%s\n")
    ...
    def Source(self, value):
        ...
        if str(value).lower() in ("ext", "line"):
            self.interface.vi_write(f":TRIG:SIMP:SOUR {str(value).upper()}")
    ...
    def Holdoff(self):
        ...
        :rtype: float
        """
        ret = self.interface.vi_query(":TRIG:HOLD:TIME?", rformat="%f\n")
        self.GetError()
        return ret
    ...
    def Holdoff(self, value):
        ...
        :type value: float
        """
        self.interface.vi_write(f":TRIG:HOLD:TIME {value:.3E}")
        self.GetError()
