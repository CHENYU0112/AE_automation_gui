...
from pverify.drivers.Scope.ykdlm4000.IIviScopeMeasurement import IIviScopeMeasurement
...
class IIviScopeMeasurements(IIviScopeBase.IIviScopeBase):
    ...
    def __init__(self, parent):
        ...
        self.__channels = {
            ...
            "C5": IIviScopeMeasurement(self.interface, "5"),
            "C6": IIviScopeMeasurement(self.interface, "6"),
            "C7": IIviScopeMeasurement(self.interface, "7"),
            "C8": IIviScopeMeasurement(self.interface, "8"),
    ...
    def Initiate(self):
        ...
        The oscilloscope acquires a waveform for each enabled channel.
        """
        if self.parent.Trigger.Continuous:
            self.interface.vi_write(":STAR")
        else:
    ...
    def Item(self, Name):
        ...
        :param Name: Channel name: "C1", "C2", "C3", "C4", "C5", "C6", "C7", "C8", "M1", "M2", "M3", "M4"
        :type Name: int
    ...
    def Name(self, Index):
        ...
        :type Index: int
        """
        if isinstance(Index, int) and 1 <= Index <= 12:
            return [
                "C1",
                "C2",
                "C3",
            ...
            msg = "ykdlm4000: Channel index exceeds the limits 1-12"
    ...
    def ConfigureMath(self, MathChannel, Expression, Unit="EU"):
        ...
        """
        if 1 <= MathChannel <= 4:
            self.interface.vi_write(":MATH%d:DISPLAY ON" % MathChannel)
