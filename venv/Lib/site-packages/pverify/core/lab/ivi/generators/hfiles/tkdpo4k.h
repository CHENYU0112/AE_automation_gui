 ...
 *---------------------------------------------------------------------------
 * (c) 2005 - 2014, National Instruments, Corporation.  All Rights Reserved.
 *---------------------------------------------------------------------------
 *
 * Title:    tkdpo4k.h
...
#define TKDPO4K_MINOR_VERSION                3     /* Instrument driver minor version   */
...
ViStatus _VI_FUNC tkdpo4k_ReadRFVersusBandwidth(ViSession vi,
