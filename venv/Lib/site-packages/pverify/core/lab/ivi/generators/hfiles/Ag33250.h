...
#define AG33250_ATTR_SYSTEM_IO_TIMEOUT                      (IVI_SPECIFIC_ATTR_BASE + 135L)  /* ViInt32, read-write */
...
/*- Defined values for
	attribute AG33250_ATTR_OUTPUT_MODE
	parameter OutputMode in function Ag33250_ConfigureOutputMode */

#define AG33250_VAL_OUTPUT_FUNC                             0
#define AG33250_VAL_OUTPUT_ARB                              1

/*- Defined values for
	attribute AG33250_ATTR_OPERATION_MODE
	parameter OperationMode in function Ag33250_ConfigureOperationMode */

#define AG33250_VAL_OPERATE_CONTINUOUS                      0
#define AG33250_VAL_OPERATE_BURST                           1

/*- Defined values for
	parameter Source in function Ag33250_ConfigureRefClockSource */
...
/*- Defined values for
	attribute AG33250_ATTR_TRIGGER_SOURCE
	parameter Source in function Ag33250_ConfigureTriggerSource */
...
/*- Defined values for
	attribute AG33250_ATTR_FUNC_WAVEFORM
	parameter Waveform in function Ag33250_ConfigureStandardWaveform */
...
/*- Defined values for
	attribute AG33250_ATTR_AM_INTERNAL_WAVEFORM
	parameter Waveform in function Ag33250_ConfigureAMInternal */
...
/*- Defined values for
	attribute AG33250_ATTR_AM_SOURCE
	parameter Source in function Ag33250_ConfigureAMSource */

#define AG33250_VAL_AM_INTERNAL                             0
#define AG33250_VAL_AM_EXTERNAL                             1

/*- Defined values for
	attribute AG33250_ATTR_FM_INTERNAL_WAVEFORM
	parameter Waveform in function Ag33250_ConfigureFMInternal */
...
/*- Defined values for
	attribute AG33250_ATTR_FM_SOURCE
	parameter Source in function Ag33250_ConfigureFMSource */

#define AG33250_VAL_FM_INTERNAL                             0
#define AG33250_VAL_FM_EXTERNAL                             1

/*- Defined values for
	attribute AG33250_ATTR_AM_INTERNAL_FUNCTION */
...
/*- Defined values for
	attribute AG33250_ATTR_OUTPUT_FUNCTION
	parameter pFunction in function Ag33250_ApplyQuery */
...
/*- Defined values for
	attribute AG33250_ATTR_OUTPUT_VOLTAGE_UNITS */
...
/*- Defined values for
	parameter Reason in function Ag33250_StatusConfigureServiceRequest */
...
/*- Defined values for
	parameter Register in function Ag33250_StatusGetRegister
...
/*- Defined values for
	parameter SubRegister in function Ag33250_StatusGetRegister
...
/*- Defined values for
	attribute AG33250_ATTR_SWEEP_SPACING */
...
ViStatus _VI_FUNC Ag33250_GetAttributeViInt64 ( ViSession Vi, ViConstString RepCapIdentifier, ViAttr AttributeID, ViInt64* AttributeValue );
...
ViStatus _VI_FUNC Ag33250_SetAttributeViInt64 ( ViSession Vi, ViConstString RepCapIdentifier, ViAttr AttributeID, ViInt64 AttributeValue );
...
ViStatus _VI_FUNC Ag33250_viRead ( ViSession Vi, ViInt64 BufferSize, ViChar Buffer[], ViInt64* ReturnCount );
ViStatus _VI_FUNC Ag33250_SystemReadString ( ViSession Vi, ViInt32 ValBufferSize, ViChar Val[] );
ViStatus _VI_FUNC Ag33250_viWrite ( ViSession Vi, ViInt64 Count, ViChar Buffer[], ViInt64* ReturnCount );
ViStatus _VI_FUNC Ag33250_SystemWriteString ( ViSession Vi, ViConstString Data );
...
#define AG33250_ERROR_CANNOT_RECOVER                        (IVIC_ERROR_BASE + 0x0000)
#define AG33250_ERROR_INSTRUMENT_STATUS                     (IVIC_ERROR_BASE + 0x0001)
#define AG33250_ERROR_CANNOT_OPEN_FILE                      (IVIC_ERROR_BASE + 0x0002)
#define AG33250_ERROR_READING_FILE                          (IVIC_ERROR_BASE + 0x0003)
#define AG33250_ERROR_WRITING_FILE                          (IVIC_ERROR_BASE + 0x0004)
#define AG33250_ERROR_INVALID_PATHNAME                      (IVIC_ERROR_BASE + 0x000B)
#define AG33250_ERROR_INVALID_VALUE                         (IVIC_ERROR_BASE + 0x0010)
#define AG33250_ERROR_FUNCTION_NOT_SUPPORTED                (IVIC_ERROR_BASE + 0x0011)
#define AG33250_ERROR_ATTRIBUTE_NOT_SUPPORTED               (IVIC_ERROR_BASE + 0x0012)
#define AG33250_ERROR_VALUE_NOT_SUPPORTED                   (IVIC_ERROR_BASE + 0x0013)
#define AG33250_ERROR_NOT_INITIALIZED                       (IVIC_ERROR_BASE + 0x001D)
#define AG33250_ERROR_UNKNOWN_CHANNEL_NAME                  (IVIC_ERROR_BASE + 0x0020)
#define AG33250_ERROR_TOO_MANY_OPEN_FILES                   (IVIC_ERROR_BASE + 0x0023)
#define AG33250_ERROR_CHANNEL_NAME_REQUIRED                 (IVIC_ERROR_BASE + 0x0044)
#define AG33250_ERROR_MISSING_OPTION_NAME                   (IVIC_ERROR_BASE + 0x0049)
#define AG33250_ERROR_MISSING_OPTION_VALUE                  (IVIC_ERROR_BASE + 0x004A)
#define AG33250_ERROR_BAD_OPTION_NAME                       (IVIC_ERROR_BASE + 0x004B)
#define AG33250_ERROR_BAD_OPTION_VALUE                      (IVIC_ERROR_BASE + 0x004C)
#define AG33250_ERROR_OUT_OF_MEMORY                         (IVIC_ERROR_BASE + 0x0056)
#define AG33250_ERROR_OPERATION_PENDING                     (IVIC_ERROR_BASE + 0x0057)
#define AG33250_ERROR_NULL_POINTER                          (IVIC_ERROR_BASE + 0x0058)
#define AG33250_ERROR_UNEXPECTED_RESPONSE                   (IVIC_ERROR_BASE + 0x0059)
#define AG33250_ERROR_FILE_NOT_FOUND                        (IVIC_ERROR_BASE + 0x005B)
#define AG33250_ERROR_INVALID_FILE_FORMAT                   (IVIC_ERROR_BASE + 0x005C)
#define AG33250_ERROR_STATUS_NOT_AVAILABLE                  (IVIC_ERROR_BASE + 0x005D)
#define AG33250_ERROR_ID_QUERY_FAILED                       (IVIC_ERROR_BASE + 0x005E)
#define AG33250_ERROR_RESET_FAILED                          (IVIC_ERROR_BASE + 0x005F)
#define AG33250_ERROR_RESOURCE_UNKNOWN                      (IVIC_ERROR_BASE + 0x0060)
#define AG33250_ERROR_ALREADY_INITIALIZED                   (IVIC_ERROR_BASE + 0x0061)
#define AG33250_ERROR_CANNOT_CHANGE_SIMULATION_STATE        (IVIC_ERROR_BASE + 0x0062)
#define AG33250_ERROR_INVALID_NUMBER_OF_LEVELS_IN_SELECTOR  (IVIC_ERROR_BASE + 0x0063)
#define AG33250_ERROR_INVALID_RANGE_IN_SELECTOR             (IVIC_ERROR_BASE + 0x0064)
#define AG33250_ERROR_UNKOWN_NAME_IN_SELECTOR               (IVIC_ERROR_BASE + 0x0065)
#define AG33250_ERROR_BADLY_FORMED_SELECTOR                 (IVIC_ERROR_BASE + 0x0066)
#define AG33250_ERROR_UNKNOWN_PHYSICAL_IDENTIFIER           (IVIC_ERROR_BASE + 0x0067)
#define AG33250_ERROR_INVALID_ATTRIBUTE                     (IVIC_ERROR_BASE + 0x000C)
#define AG33250_ERROR_TYPES_DO_NOT_MATCH                    (IVIC_ERROR_BASE + 0x0015)
#define AG33250_ERROR_IVI_ATTR_NOT_WRITABLE                 (IVIC_ERROR_BASE + 0x000D)
#define AG33250_ERROR_IVI_ATTR_NOT_READABLE                 (IVIC_ERROR_BASE + 0x000E)
#define AG33250_ERROR_INVALID_SESSION_HANDLE                (IVIC_ERROR_BASE + 0x1190)



#define AG33250_SUCCESS                                     0
#define AG33250_WARN_NSUP_ID_QUERY                          (IVIC_WARN_BASE + 0x0065)
#define AG33250_WARN_NSUP_RESET                             (IVIC_WARN_BASE + 0x0066)
#define AG33250_WARN_NSUP_SELF_TEST                         (IVIC_WARN_BASE + 0x0067)
#define AG33250_WARN_NSUP_ERROR_QUERY                       (IVIC_WARN_BASE + 0x0068)
#define AG33250_WARN_NSUP_REV_QUERY                         (IVIC_WARN_BASE + 0x0069)



#define AG33250_ERROR_TRIGGER_NOT_SOFTWARE                  (IVIC_CROSS_CLASS_ERROR_BASE + 0x0001)
#define AG33250_ERROR_NO_WFMS_AVAILABLE                     (IVIC_CLASS_ERROR_BASE + 0x0004)
#define AG33250_ERROR_WFM_IN_USE                            (IVIC_CLASS_ERROR_BASE + 0x0008)
#define AG33250_ERROR_NO_SEQS_AVAILABLE                     (IVIC_CLASS_ERROR_BASE + 0x0009)
#define AG33250_ERROR_SEQ_IN_USE                            (IVIC_CLASS_ERROR_BASE + 0x000D)
#define AG33250_ERROR_PERSONALITY_NOT_ACTIVE                (IVIC_SPECIFIC_ERROR_BASE + 0x0211)
#define AG33250_ERROR_PERSONALITY_NOT_INSTALLED             (IVIC_SPECIFIC_ERROR_BASE + 0x0212)
#define AG33250_ERROR_PERSONALITY_NOT_LICENSED              (IVIC_SPECIFIC_ERROR_BASE + 0x0213)
#define AG33250_ERROR_IO_GENERAL                            (IVIC_SPECIFIC_ERROR_BASE + 0x0214)
#define AG33250_ERROR_IO_TIMEOUT                            (IVIC_SPECIFIC_ERROR_BASE + 0x0215)
#define AG33250_ERROR_MODEL_NOT_SUPPORTED                   (IVIC_SPECIFIC_ERROR_BASE + 0x0216)
#define AG33250_ERROR_WRAPPED_DRIVER_ERROR                  (IVIC_SPECIFIC_ERROR_BASE + 0x0218)
#define AG33250_ERROR_MAX_TIME_EXCEEDED                     (IVIC_SPECIFIC_ERROR_BASE + 0x0217)
#define AG33250_ERROR_NOT_SUPPORTED                         (IVIC_SPECIFIC_ERROR_BASE + 0x0219)
