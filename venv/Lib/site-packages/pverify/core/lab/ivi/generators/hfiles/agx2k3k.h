...
#define AGX2K3K_MINOR_VERSION                0     /* Instrument driver minor version   */
...
/* #define AGX2K3K_VAL_POSITIVE           DEFINED ABOVE */
/* #define AGX2K3K_VAL_NEGATIVE           DEFINED ABOVE */
/* #define AGX2K3K_VAL_EITHER             DEFINED ABOVE */
...
ViStatus _VI_FUNC  agx2k3k_init (ViRsrc resourceName, ViBoolean IDQuery,
                                  ViBoolean resetDevice, ViSession *vi);

ViStatus _VI_FUNC  agx2k3k_InitWithOptions (ViRsrc resourceName, ViBoolean IDQuery,
                                             ViBoolean resetDevice, ViConstString optionString,
                                             ViSession *newVi);

ViStatus _VI_FUNC  agx2k3k_close (ViSession vi);

ViStatus _VI_FUNC agx2k3k_DeviceClear (ViSession instrumentHandle);

    /*- Coercion Info Functions --------------------------------------------*/
ViStatus _VI_FUNC  agx2k3k_GetNextCoercionRecord (ViSession vi,
                                                   ViInt32 bufferSize,
                                                   ViChar record[]);

    /*- Locking Functions --------------------------------------------------*/
ViStatus _VI_FUNC  agx2k3k_LockSession (ViSession vi, ViBoolean *callerHasLock);

ViStatus _VI_FUNC  agx2k3k_UnlockSession (ViSession vi, ViBoolean *callerHasLock);

    /*- Channel Info Functions ---------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_GetChannelName (ViSession vi, ViInt32 index,
                                   		ViInt32 bufferSize, ViChar name[]);

    /*- Acquisition Subsystem Configuration ---------------------------------*/
ViStatus _VI_FUNC  agx2k3k_ConfigureAcquisitionType (ViSession vi,
                                                      ViInt32 acquisitionType);

ViStatus _VI_FUNC agx2k3k_ConfigureAcquisitionMode (ViSession vi,
                                                   ViInt32 acquisitionMode);

ViStatus _VI_FUNC  agx2k3k_ConfigureAcquisitionRecord (ViSession vi,
                                                        ViReal64 timePerRecord,
                                                        ViInt32 minimumRecordLength,
                                                        ViReal64 acqStartTime);

ViStatus _VI_FUNC agx2k3k_ConfigureRecordMode (ViSession vi,
                                                ViInt32 horizontalRecordMode);

ViStatus _VI_FUNC  agx2k3k_ConfigureNumAverages (ViSession vi,
                                                  ViInt32 numberOfAverages);

ViStatus _VI_FUNC  agx2k3k_SampleMode (ViSession vi, ViInt32 *sampleMode);

ViStatus _VI_FUNC  agx2k3k_SampleRate (ViSession vi, ViReal64 *sampleRate);

ViStatus _VI_FUNC agx2k3k_ConfigureFunBus (ViSession vi,
                                           ViInt32 busClock, ViInt32 busSlope,
                                           ViReal64 busIncrementY,
                                           ViReal64 busOriginY, ViInt32 busUnitY);
ViStatus _VI_FUNC agx2k3k_ConfigureFunBusMultiChan  (ViSession vi, ViChar FunctionChannel[],
                                           ViInt32 busClock, ViInt32 busSlope,
                                           ViReal64 busIncrementY,
                                           ViReal64 busOriginY, ViInt32 busUnitY);

ViStatus _VI_FUNC agx2k3k_ConfigureFunTrendMeas (ViSession vi,
                                                 ViInt32 trendMeasurement);
ViStatus _VI_FUNC agx2k3k_ConfigureTrendMeasMultiChan (ViSession vi, ViChar FunctionChannel[],
                                                 ViInt32 trendMeasurement);

ViStatus _VI_FUNC agx2k3k_ConfigureFunLinear (ViSession vi,
                                              ViReal64 linearGain,
                                              ViReal64 linearOffset);
ViStatus _VI_FUNC agx2k3k_ConfigureFunLinearMultiChan (ViSession vi, ViChar Function_Channel[],
                                              ViReal64 linearGain,
                                              ViReal64 linearOffset);

ViStatus _VI_FUNC agx2k3k_ConfigureFunFrequency (ViSession vi,
                                                 ViReal64 highPass,
                                                 ViReal64 lowPass);
ViStatus _VI_FUNC agx2k3k_ConfigureFunFreqMultiChan (ViSession vi, ViChar Function_Channel[],
                                                 ViReal64 highPass,
                                                 ViReal64 lowPass);

ViStatus _VI_FUNC agx2k3k_ConfigureFunFFTUnit (ViSession vi,
                                               ViInt32 unit);
ViStatus _VI_FUNC agx2k3k_ConfigureFFTUnitMultiChan (ViSession vi, ViChar Function_Channel[],
                                               ViInt32 unit);

ViStatus _VI_FUNC agx2k3k_ConfigureFunInputOffset (ViSession vi,
                                                   ViReal64 inputOffset);

ViStatus _VI_FUNC agx2k3k_ConfigureInputOffsMultiChan (ViSession vi, ViChar Function_Channel[],
                                                   ViReal64 inputOffset);

ViStatus _VI_FUNC agx2k3k_ConfigureMathChannelEnabled (ViSession vi,
                                                      ViBoolean channelEnabled);
ViStatus _VI_FUNC agx2k3k_ConfigureMathChanMultiChan (ViSession vi, ViChar Function_Channel[],
                                                      ViBoolean channelEnabled);

ViStatus _VI_FUNC agx2k3k_ConfigureMathFunction (ViSession vi,
                                                ViConstString source1,
                                                ViConstString source2,
                                                ViInt32 operation);

ViStatus _VI_FUNC agx2k3k_ConfigureMathSettings (ViSession vi,
                                                ViReal64 scale, ViReal64 offset);
ViStatus _VI_FUNC agx2k3k_ConfigureMathMultiChan (ViSession vi, ViChar Function_Channel[],
                                                ViReal64 scale, ViReal64 offset);

ViStatus _VI_FUNC agx2k3k_ConfigureMathFFT (ViSession vi,
                                           ViReal64 span, ViReal64 center,
                                           ViInt32 window);
ViStatus _VI_FUNC agx2k3k_ConfigureMathFFTMultiChan (ViSession vi,
										             ViChar FunctionChannel[],
                                           			 ViReal64 span,
                                           			 ViReal64 center,
                                           			 ViInt32 window);

ViStatus _VI_FUNC agx2k3k_ActualRecordLength (ViSession vi,
                                              ViInt32 *actualRecordLength);

ViStatus _VI_FUNC agx2k3k_ConfigureInitiateContinuous (ViSession vi,
                                                       ViBoolean continuous);

ViStatus _VI_FUNC agx2k3k_ConfigureAcquisitionSegment (ViSession vi,
                                                       ViBoolean segmentAnalyzeEnable,
                                                       ViInt32 segmentCount,
                                                       ViInt32 segmentIndex);

    /*- Channel Subsystem Configuration -------------------------------------*/
ViStatus _VI_FUNC  agx2k3k_ConfigureChannel (ViSession vi,
...
ViStatus _VI_FUNC agx2k3k_ConfigureDigitalChannel (ViSession vi,
                                                  ViConstString channelName,
                                                  ViInt32 size,
                                                  ViReal64 threshold,
                                                  ViBoolean channelEnabled);

ViStatus _VI_FUNC agx2k3k_ConfigureChanCharacteristics (ViSession vi,
                                                       ViConstString channel,
                                                       ViReal64 inputImpedance,
                                                       ViReal64 maxInputFrequency);

ViStatus _VI_FUNC agx2k3k_AutoProbeSenseValue (ViSession vi,
                                              ViConstString channel,
                                              ViReal64 *autoProbeSenseValue);

ViStatus _VI_FUNC agx2k3k_ConfigureChannelInvert (ViSession vi,
                                                 ViConstString channel,
                                                 ViBoolean invert);

ViStatus _VI_FUNC agx2k3k_ConfigureChannelVernier (ViSession vi,
                                                  ViConstString channel,
                                                  ViBoolean vernier);

ViStatus _VI_FUNC agx2k3k_ConfigureChannelProbe (ViSession vi,
                                                ViConstString channel,
                                                ViReal64 skew, ViInt32 units);

ViStatus _VI_FUNC agx2k3k_ConfigureChannelLabel (ViSession vi,
                                                ViConstString channel,
                                                ViConstString label);

ViStatus _VI_FUNC agx2k3k_ConfigureDigitalPosition (ViSession vi,
                                                   ViConstString channelName,
                                                   ViInt32 position);

ViStatus _VI_FUNC agx2k3k_ConfigureTimebaseMode (ViSession vi,
                                                ViInt32 timebaseMode);

ViStatus _VI_FUNC agx2k3k_ConfigureTimebase (ViSession vi,
                                            ViInt32 reference,
                                            ViBoolean vernier);

ViStatus _VI_FUNC agx2k3k_ConfigureWindowTimebase (ViSession vi,
                                                  ViReal64 position,
                                                  ViReal64 range,
                                                  ViReal64 scale);

    /*- Triggering Subsystem Configuration ----------------------------------*/
ViStatus _VI_FUNC  agx2k3k_ConfigureTrigger (ViSession vi,
                                              ViInt32 triggerType,
                                              ViReal64 holdoff);

ViStatus _VI_FUNC  agx2k3k_ConfigureTriggerCoupling (ViSession vi,
                                                      ViInt32 coupling);

ViStatus _VI_FUNC  agx2k3k_ConfigureTriggerModifier (ViSession vi,
                                                      ViInt32 modifier);

ViStatus _VI_FUNC agx2k3k_ConfigureTriggerReject (ViSession vi,
                                                 ViBoolean noiseReject,
                                                 ViBoolean HFReject);

ViStatus _VI_FUNC agx2k3k_ConfigureTriggerLevel (ViSession vi,
                                                 ViReal64 levelHigh,
                                                 ViReal64 levelLow);

ViStatus _VI_FUNC  agx2k3k_ConfigureEdgeTriggerSource (ViSession vi,
                                                        ViConstString source,
                                                        ViReal64 level,
                                                        ViInt32 slope);

ViStatus _VI_FUNC agx2k3k_ConfigureRuntTriggerSource (ViSession vi,
                                                      ViConstString triggerSource,
                                                      ViInt32 runtPolarity,
                                                      ViInt32 triggerCondition,
                                                      ViReal64 runtTime);

ViStatus _VI_FUNC agx2k3k_ConfigureTransitionTrigger (ViSession vi,
                                                      ViConstString triggerSource,
                                                      ViInt32 slope,
                                                      ViInt32 triggerCondition,
                                                      ViReal64 transitionTime);

ViStatus _VI_FUNC agx2k3k_ConfigureSetupHoldTrigger (ViSession vi,
...
ViStatus _VI_FUNC agx2k3k_ConfigureTVTriggerSource (ViSession vi,
                                                     ViConstString source,
                                                     ViInt32 TVSignalFormat,
                                                     ViInt32 TVEvent,
                                                     ViInt32 TVPolarity);

ViStatus _VI_FUNC agx2k3k_ConfigureTVTriggerLineNumber (ViSession vi,
                                                         ViInt32 lineNumber);

ViStatus _VI_FUNC agx2k3k_ConfigureIICBusSource (ViSession vi,
                                                 ViConstString busName,
                                                 ViConstString serialClockSource,
                                                 ViConstString serialDataSource,
                                                 ViInt32 type);

ViStatus _VI_FUNC agx2k3k_ConfigureIICEEPROMQualifier (ViSession vi,
                                                       ViConstString busName,
                                                       ViInt32 qualifier);

ViStatus _VI_FUNC agx2k3k_ConfigureIICData (ViSession vi,
                                            ViConstString busName,
                                            ViInt32 address,
                                            ViInt32 addressSize,
                                            ViInt32 data,
...
ViStatus _VI_FUNC agx2k3k_ConfigureI2SBusSource (ViSession vi,
                                                 ViConstString busName,
                                                 ViConstString clockSource,
                                                 ViConstString dataSource,
                                                 ViConstString wsSource);

ViStatus _VI_FUNC agx2k3k_ConfigureI2SBus (ViSession vi,
                                           ViConstString busName,
                                           ViInt32 rxWidth,
                                           ViInt32 txWidth,
                                           ViInt32 wsPolarity,
...
ViStatus _VI_FUNC agx2k3k_ConfigureI2STrigger (ViSession vi,
                                               ViConstString busName,
                                               ViInt32 triggerCondition,
...
ViStatus _VI_FUNC agx2k3k_ConfigureLINBus (ViSession vi,
                                           ViConstString busName,
...
ViStatus _VI_FUNC agx2k3k_ConfigureLINTrigger (ViSession vi,
                                               ViConstString busName,
                                               ViInt32 triggerCondition,
...
ViStatus _VI_FUNC agx2k3k_ConfigureSPITrigger (ViSession vi,
                                               ViConstString busName,
                                               ViInt32 triggerType,
...
ViStatus _VI_FUNC agx2k3k_ConfigureSBusFlexrayTrigger (ViSession vi,
                                                       ViChar busName[],
                                                       ViInt32 trigger,
...
ViStatus _VI_FUNC agx2k3k_ConfigureSPIBus (ViSession vi,
                                           ViConstString busName,
                                           ViConstString clockSource,
                                           ViConstString dataSource,
...
ViStatus _VI_FUNC agx2k3k_ConfigureSPITriggerTimeout (ViSession vi,
                                                      ViConstString busName,
                                                      ViReal64 timeout);

ViStatus _VI_FUNC agx2k3k_ConfigureEdgeTriggerReject (ViSession vi,
                                                      ViInt32 triggerRejectFilter);

ViStatus _VI_FUNC agx2k3k_ConfigureEdgeBurstTrigger (ViSession vi,
                                                     ViConstString triggerSource,
                                                     ViInt32 slope,
                                                     ViInt32 count,
                                                     ViReal64 idleTime);

ViStatus _VI_FUNC agx2k3k_ConfigureGlitchTriggerSource (ViSession vi,
                                                         ViConstString source,
                                                         ViReal64 level,
...
ViStatus _VI_FUNC agx2k3k_ConfigureGlitchWidth (ViSession vi,
                                                ViReal64 minWidth);

ViStatus _VI_FUNC agx2k3k_ConfigureGlitchRange (ViSession vi,
                                               ViReal64 greaterThanTime,
                                               ViReal64 lessThanTime);

ViStatus _VI_FUNC agx2k3k_ConfigurePatternTrigger (ViSession vi,
                                                   ViConstString patternValue,
                                                   ViInt32 triggerCondition,
                                                   ViReal64 greaterThanTime,
                                                   ViReal64 lessThanTime);

ViStatus _VI_FUNC agx2k3k_ConfigureCANBus (ViSession vi,
                                           ViConstString busName,
                                           ViConstString source,
                                           ViInt32 baudRate,
                                           ViInt32 signal);

ViStatus _VI_FUNC agx2k3k_ConfigureCANTrigger (ViSession vi,
                                               ViConstString busName,
                                               ViInt32 trigger,
                                               ViInt32 dataLength,
                                               ViConstString patternData,
...
ViStatus _VI_FUNC agx2k3k_ConfigureGeneratorAmplitude (ViSession vi,
...
ViStatus _VI_FUNC agx2k3k_ConfigureGenAmpMultiChan (ViSession vi,
...
ViStatus _VI_FUNC agx2k3k_ConfigureWaveform (ViSession vi,
                                             ...
                                             ViReal64 dutyCycle,
                                             ViReal64 pulseWidth);
ViStatus _VI_FUNC agx2k3k_ConfigureWaveformMultiChan (ViSession vi,
											 ViChar WaveGenChannel[],
                                             ViInt32 functionType,
                                             ViInt32 settingSytle,
                                             ViReal64 period,
...
ViStatus _VI_FUNC agx2k3k_EnableGeneratorOutput (ViSession vi,
                                                 ViBoolean enableOutput);
ViStatus _VI_FUNC agx2k3k_EnableGenOutputMultiChan (ViSession vi, ViChar Wave_Gen_Channel[],
                                                 ViBoolean enableOutput);

    /*- Waveform Acquisition ------------------------------------------------*/
ViStatus _VI_FUNC  agx2k3k_ReadWaveform (ViSession vi,
                                          ViConstString channel,
...
ViStatus _VI_FUNC  agx2k3k_InitiateAcquisition (ViSession vi);

ViStatus _VI_FUNC  agx2k3k_AcquisitionStatus (ViSession vi, ViInt32 *status);

ViStatus _VI_FUNC  agx2k3k_Abort (ViSession vi);

ViStatus _VI_FUNC agx2k3k_FetchEfficiency (ViSession instrumentHandle,
                                           ViReal64 *measurement);

ViStatus _VI_FUNC agx2k3k_FetchRipple (ViSession instrumentHandle,
                                       ViChar channelName[],
                                       ViReal64 *measurement);

ViStatus _VI_FUNC  agx2k3k_FetchWaveform (ViSession vi,
                                           ViConstString channel,
                                           ViInt32 waveformSize,
                                           ViReal64 waveform[],
                                           ViInt32 *actualPoints,
...
ViStatus _VI_FUNC agx2k3k_ReadEfficiency (ViSession instrumentHandle,
                                          ViReal64 *measurement);

ViStatus _VI_FUNC agx2k3k_ReadRipple (ViSession instrumentHandle,
                                      ViChar channelName[],
                                      ViReal64 *measurement);

    /* Used when AGX2K3K_ATTR_ACQUISTION_TYPE is either */
    /* AGX2K3K_VAL_PEAK_DETECT */
ViStatus _VI_FUNC  agx2k3k_ReadMinMaxWaveform (ViSession vi,
                                                ViConstString channel,
                                                ViInt32 waveformSize,
                                                ViInt32 maxTime,
    ...
    /* Used when AGX2K3K_ATTR_ACQUISTION_TYPE is either */
    /* AGX2K3K_VAL_PEAK_DETECT */
ViStatus _VI_FUNC  agx2k3k_FetchMinMaxWaveform (ViSession vi,
                                                 ViConstString channel,
                                                 ViInt32 waveformSize,
                                                 ViReal64 minWaveform[],
                                                 ViReal64 maxWaveform[],
...
ViStatus _VI_FUNC agx2k3k_ConfigureUSBTriggerSource (ViSession vi,
                                                    ViInt32 trigger, ViInt32 speed,
                                                    ViConstString dPlus, ViConstString dMinus);

ViStatus _VI_FUNC agx2k3k_ConfigureMeasSource (ViSession vi,
                                              ViConstString source1,
                                              ViConstString source2);

ViStatus _VI_FUNC agx2k3k_ConfigureMeasurementDelay (ViSession vi,
                                                    ViInt32 edgeSpec1,
                                                    ViInt32 edgeSpec2);

    /*- Waveform Measurements ----------------------------------------------*/
ViStatus _VI_FUNC  agx2k3k_ConfigureRefLevels (ViSession vi,
                                                ViReal64 lowRef,
                                                ViReal64 midRef,
                                                ViReal64 highRef);

ViStatus _VI_FUNC  agx2k3k_ReadWaveformMeasurement (ViSession vi,
                                                     ViConstString channel,
                                                     ViInt32 measurementFunction,
                                                     ViInt32 maxTime,
                                                     ViReal64 *measurement);

ViStatus _VI_FUNC  agx2k3k_FetchWaveformMeasurement (ViSession vi,
                                                      ViConstString channel,
                                                      ViInt32 measurementFunction,
                                                      ViReal64 *measurement);

ViStatus _VI_FUNC agx2k3k_ConfigureUARTBus (ViSession vi,
                                            ViConstString busName,
                                            ViInt32 baudRate,
                                            ViInt32 bitOrder,
...
ViStatus _VI_FUNC agx2k3k_ConfigureUARTBusSource (ViSession vi,
                                                  ViConstString busName,
                                                  ViConstString rxSource,
                                                  ViConstString txSource);

ViStatus _VI_FUNC agx2k3k_ConfigureUARTTrigger (ViSession vi,
                                                ViConstString busName,
                                                ViInt32 triggerType,
                                                ViInt32 triggerCondition,
                                                ViInt32 triggerData,
    ...
    /*- Auto Setup ----------------------------------------------------------*/
ViStatus _VI_FUNC  agx2k3k_AutoSetup (ViSession vi);

    /*- Utility -------------------------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_IsInvalidWfmElement (ViSession vi, ViReal64 elementValue,
                                                    ViBoolean *isInvalid);

    /*- Error Functions ----------------------------------------------------*/
ViStatus _VI_FUNC  agx2k3k_error_query (ViSession vi, ViInt32 *errorCode,
                                         ViChar errorMessage[]);

ViStatus _VI_FUNC  agx2k3k_GetError (ViSession vi, ViStatus *code,
                                      ViInt32 bufferSize, ViChar description[]);

ViStatus _VI_FUNC  agx2k3k_ClearError (ViSession vi);

ViStatus _VI_FUNC  agx2k3k_error_message (ViSession vi, ViStatus errorCode,
                                           ViChar errorMessage[256]);

    /*- Interchangeability Checking Functions ------------------------------*/
ViStatus _VI_FUNC agx2k3k_GetNextInterchangeWarning (ViSession vi,
                                                      ViInt32 bufferSize,
                                                      ViChar warnString[]);

ViStatus _VI_FUNC agx2k3k_ResetInterchangeCheck (ViSession vi);

ViStatus _VI_FUNC agx2k3k_ClearInterchangeWarnings (ViSession vi);

    /*- Utility Functions --------------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_InvalidateAllAttributes (ViSession vi);

ViStatus _VI_FUNC  agx2k3k_reset (ViSession vi);

ViStatus _VI_FUNC  agx2k3k_ResetWithDefaults (ViSession vi);

ViStatus _VI_FUNC  agx2k3k_self_test (ViSession vi, ViInt16 *selfTestResult,
                                       ViChar selfTestMessage[]);

ViStatus _VI_FUNC  agx2k3k_revision_query (ViSession vi,
                                            ViChar instrumentDriverRevision[],
                                            ViChar firmwareRevision[]);

ViStatus _VI_FUNC agx2k3k_Disable (ViSession vi);

ViStatus _VI_FUNC  agx2k3k_WriteInstrData (ViSession vi, ViConstString writeBuffer);

ViStatus _VI_FUNC  agx2k3k_ReadInstrData  (ViSession vi, ViInt32 numBytes,
                                            ViChar rdBuf[], ViInt32 *bytesRead);

    /*- Set, Get, and Check Attribute Functions ----------------------------*/
ViStatus _VI_FUNC  agx2k3k_GetAttributeViInt32 (ViSession vi, ViConstString channelName, ViAttr attribute, ViInt32 *value);

ViStatus _VI_FUNC  agx2k3k_GetAttributeViReal64 (ViSession vi, ViConstString channelName, ViAttr attribute, ViReal64 *value);

ViStatus _VI_FUNC  agx2k3k_GetAttributeViString (ViSession vi, ViConstString channelName, ViAttr attribute, ViInt32 bufSize, ViChar value[]);

ViStatus _VI_FUNC  agx2k3k_GetAttributeViSession (ViSession vi, ViConstString channelName, ViAttr attribute, ViSession *value);

ViStatus _VI_FUNC  agx2k3k_GetAttributeViBoolean (ViSession vi, ViConstString channelName, ViAttr attribute, ViBoolean *value);

ViStatus _VI_FUNC  agx2k3k_SetAttributeViInt32 (ViSession vi, ViConstString channelName, ViAttr attribute, ViInt32 value);

ViStatus _VI_FUNC  agx2k3k_SetAttributeViReal64 (ViSession vi, ViConstString channelName, ViAttr attribute, ViReal64 value);

ViStatus _VI_FUNC  agx2k3k_SetAttributeViString (ViSession vi, ViConstString channelName, ViAttr attribute, ViConstString value);

ViStatus _VI_FUNC  agx2k3k_SetAttributeViSession (ViSession vi, ViConstString channelName, ViAttr attribute, ViSession value);

ViStatus _VI_FUNC  agx2k3k_SetAttributeViBoolean (ViSession vi, ViConstString channelName, ViAttr attribute, ViBoolean value);

ViStatus _VI_FUNC  agx2k3k_CheckAttributeViInt32 (ViSession vi, ViConstString channelName, ViAttr attribute, ViInt32 value);

ViStatus _VI_FUNC  agx2k3k_CheckAttributeViReal64 (ViSession vi, ViConstString channelName, ViAttr attribute, ViReal64 value);

ViStatus _VI_FUNC  agx2k3k_CheckAttributeViString (ViSession vi, ViConstString channelName, ViAttr attribute, ViConstString value);

ViStatus _VI_FUNC  agx2k3k_CheckAttributeViSession (ViSession vi, ViConstString channelName, ViAttr attribute, ViSession value);

ViStatus _VI_FUNC  agx2k3k_CheckAttributeViBoolean (ViSession vi, ViConstString channelName, ViAttr attribute, ViBoolean value);

/*********************************************************
        Functions reserved for class driver use only.
        End-users should not call these functions.
     *********************************************************/
ViStatus _VI_FUNC  agx2k3k_IviInit (ViRsrc resourceName, ViBoolean IDQuery,
                                     ViBoolean reset, ViSession vi);

ViStatus _VI_FUNC  agx2k3k_IviClose (ViSession vi);
...
ViStatus _VI_FUNC agx2k3k_ConfigureSignalSource(ViSession vi, ViInt32 CurrentFirstSource, ViInt32 CurrentSecondSource,
                  								ViInt32 VoltageFirstSource, ViInt32 VoltageSecondSource);
ViStatus _VI_FUNC agx2k3k_AutoSetupPowerSignal(ViSession vi, ViInt32 PowerAnalysisType);
ViStatus _VI_FUNC agx2k3k_ApplyPowerQuality(ViSession vi);
ViStatus _VI_FUNC agx2k3k_ApplyPowerSLEW(ViSession vi);
ViStatus _VI_FUNC agx2k3k_ConfigurePowerSLEWSource(ViSession vi, ViInt32 Source);
ViStatus _VI_FUNC agx2k3k_ApplyPowerRipple(ViSession vi);
ViStatus _VI_FUNC agx2k3k_ConfigurePowerQuality(ViSession vi, ViInt32 QualityType);
ViStatus _VI_FUNC agx2k3k_ApplyPowerOnOff(ViSession vi);
ViStatus _VI_FUNC agx2k3k_ApplyPowerPSRR(ViSession vi);
ViStatus _VI_FUNC agx2k3k_ConfigurePowerPSRR(ViSession vi, ViInt32 FreqMax, ViInt32 FreqMin, ViInt32 MaxRatioValue);
ViStatus _VI_FUNC agx2k3k_ConfigurePowerSignal(ViSession vi, ViInt32 SignalCycles, ViReal64 SignalDuration,
							                  ViReal64 SignalInrushExpected, ViInt32 SignalOvershoot, ViReal64 MaxExpectedVoltage,
							                  ViReal64 SteadyStateVoltage);
ViStatus _VI_FUNC agx2k3k_StopPowerOnOff(ViSession vi);
ViStatus _VI_FUNC agx2k3k_NextPowerOnOff(ViSession vi);
ViStatus _VI_FUNC agx2k3k_ApplyPowerInrush(ViSession vi);
ViStatus _VI_FUNC agx2k3k_ApplyPowerModulation(ViSession vi);
ViStatus _VI_FUNC agx2k3k_ConfigurePowerModulation(ViSession vi, ViInt32 ModulationSource, ViInt32 ModulationType);
ViStatus _VI_FUNC agx2k3k_StopPowerInrush(ViSession vi);
ViStatus _VI_FUNC agx2k3k_NextPowerInrush(ViSession vi);
ViStatus _VI_FUNC agx2k3k_ConfigurePowerHarmonics(ViSession vi, ViInt32 DisplayStyle, ViInt32 FreqSettingLine, ViInt32 Standard);
ViStatus _VI_FUNC agx2k3k_ApplyPowerEfficiency(ViSession vi);
ViStatus _VI_FUNC agx2k3k_ApplyPowerHarmonics(ViSession vi);
ViStatus _VI_FUNC agx2k3k_EnablePowerAnalysis(ViSession vi, ViBoolean PowerAnalysisEnabled);
ViStatus _VI_FUNC agx2k3k_LaunchAutoDeskew(ViSession vi);
ViStatus _VI_FUNC agx2k3k_ApplyPowerSwitch(ViSession vi);
ViStatus _VI_FUNC agx2k3k_ConfigurePowerSwitch(ViSession vi, ViInt32 SwitchConduction, ViInt32 CurrentSwitchPercent,
											  ViInt32 VoltageSwitchPercent, ViReal64 SwitchRDS, ViReal64 SwitchVCE);
ViStatus _VI_FUNC agx2k3k_ApplyPowerTransient(ViSession vi);
ViStatus _VI_FUNC agx2k3k_StopPowerTransient(ViSession vi);
ViStatus _VI_FUNC agx2k3k_NextPowerTransient(ViSession vi);
ViStatus _VI_FUNC agx2k3k_ConfigurePowerTransient(ViSession vi, ViReal64 InitCurrent, ViReal64 NewCurrent);

/*- Search Group Group Functions ----------------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_ConfigureSearchSerialA429(ViSession vi, ViInt32 Label, ViInt32 Mode,
                  ViConstString PatternData, ViConstString PatternSDI, ViConstString PatternSSM);
ViStatus _VI_FUNC agx2k3k_ConfigureSearchSerialFlexray(ViSession vi, ViInt32 Cycle, ViInt32 Mode,
                  ViConstString Data, ViInt32 FrameID, ViInt32 DataLength);
ViStatus _VI_FUNC agx2k3k_ConfigureSearchSerialM1553(ViSession vi, ViInt32 Mode, ViConstString PatternData,
													  ViInt32 RemoteTerminalAddress);

/*- Recall Group Group Functions ----------------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_RecallDataFromFile(ViSession vi, ViConstString FileName, ViInt32 StartColumn);

/*- Measurement Goup Group Functions ----------------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_ConfigureMeasureStatistics(ViSession vi, ViBoolean DeviationEnabled, ViInt32 MaxStatisticsNumber);

/*- Demo Group Group Functions ----------------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_ConfigureDemoFunction(ViSession vi, ViInt32 DemoFunction);

/*- Trigger Group Group Functions ----------------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_ForceTrigger(ViSession vi);
ViStatus _VI_FUNC agx2k3k_ConfigureTriggerDelay(ViSession vi, ViInt32 ArmSlope, ViInt32 ArmSource,
											  ViReal64 DelayTime, ViInt32 TriggerCount, ViInt32 TriggerSlope,
											  ViInt32 TriggerSource);
ViStatus _VI_FUNC agx2k3k_ConfigureTriggerPattern(ViSession vi, ViInt32 Format, ViInt32 Qualifier,
												  ViReal64 GreaterThan, ViReal64 LessThan);
ViStatus _VI_FUNC agx2k3k_ConfigureTriggerTV (ViSession vi,
                                              ViInt32 UDTVEnumber,
...
ViStatus _VI_FUNC agx2k3k_SaveArbitraryWave (ViSession vi, ViConstString fileName);
ViStatus _VI_FUNC agx2k3k_SavePowerAnalysis (ViSession vi, ViConstString fileName);
ViStatus _VI_FUNC agx2k3k_EnableSaveMaxWave(ViSession vi, ViBoolean SaveMaxWaveEnabled);

/*- SBUS Group Group Functions ----------------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_AutoSetupA429 (ViSession vi, ViConstString busName);
ViStatus _VI_FUNC agx2k3k_AutoSetupFlexray (ViSession vi, ViConstString busName);
ViStatus _VI_FUNC agx2k3k_AutoSetupM1553 (ViSession vi, ViConstString busName);
ViStatus _VI_FUNC agx2k3k_ResetSBusA429 (ViSession vi, ViConstString busName);
ViStatus _VI_FUNC agx2k3k_ResetSBusFlexray (ViSession vi, ViConstString busName);
ViStatus _VI_FUNC agx2k3k_ConfigureSBusA429(ViSession vi, ViConstString BusName, ViInt32 Base,
											  ViInt32 Format, ViInt32 Signal, ViInt32 Source, ViInt32 SignalSpeed);
ViStatus _VI_FUNC agx2k3k_ConfigureSBusFlexray(ViSession vi, ViConstString BusName, ViInt32 Baudrate,
											  ViInt32 Channel, ViInt32 Source);

ViStatus _VI_FUNC agx2k3k_ConfigureSBusA429Trigger (ViSession vi,
                                                    ViChar busName[],
...
ViStatus _VI_FUNC agx2k3k_ConfigureSBusM1553 ( ViSession vi, ViConstString BusName, ViInt32 Base,
											  ViInt32 Source, ViInt32 TriggerRTA, ViConstString TriggerPatternData,
											  ViInt32 TriggerType);


/*- Marker Group Group Functions ----------------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_ConfigureMarkerXCursorUnit(ViSession vi, ViInt32 XCursorUnit, ViBoolean ResetXCursorLocation);
ViStatus _VI_FUNC agx2k3k_ConfigureMarkerYCursorUnit(ViSession vi, ViInt32 YCursorUnit, ViBoolean ResetYCursorLocation);

/*- WGEN Group Group Functions ----------------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_ConfigureModulationNoise (ViSession vi, ViInt32 byteOrder, ViBoolean interpolateEnabled, ViInt32 noisePercent);
ViStatus _VI_FUNC agx2k3k_ConfigureModNoiseMultiChan (ViSession vi, ViChar WaveGenChannel[], ViInt32 ByteOrder, ViInt32 NoisePercent);

    /* New functions added in version 3.0 */

/*- Acquisition Group Group Functions ----------------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_ConfigureRefSignalType(ViSession vi, ViInt32 ReferenceSignalMode);

/*- Digital Voltmeter Group Group Functions ----------------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_ConfigureDigitalVoltmeter(ViSession vi, ViBoolean AutoRange, ViBoolean EnableDVM,
													  ViInt32 DVMMode, ViInt32 DVMAnalogSource);
ViStatus _VI_FUNC agx2k3k_ReadDigitalVoltmeter(ViSession vi, ViReal64* DVMFrequency, ViReal64* DVMCurrent);

/*- Function Group Group Functions ----------------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_ConfigureFunAverageNumber(ViSession vi, ViChar FunctionChannel[], ViInt32 NumberAverages);
ViStatus _VI_FUNC agx2k3k_ConfigureSelectedFunction(ViSession vi, ViChar FunctionChannel[], ViReal64 VerticalAxis, ViReal64 ReferenceLevel);

/*- Marker Group Group Functions ----------------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_ConfigureMarkerUnits(ViSession vi, ViInt32 Dimension);

/*- Measurement Group Group Functions ----------------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_ReadQualityPowerAnalysis(ViSession vi, ViReal64 *PhaseAngle, ViReal64 *ApparentPower,
												  ViReal64 *CrestFactor, ViReal64 *PowerFactor, ViReal64 *ReactivePower, ViReal64 *RealPower);
ViStatus _VI_FUNC agx2k3k_ReadCurrentValue(ViSession vi, ViReal64 *Area);
ViStatus _VI_FUNC agx2k3k_ClearMeasurementsMarkers(ViSession vi);
ViStatus _VI_FUNC agx2k3k_ReadSwitchLossPowerAnalysis(ViSession vi, ViReal64 *PowerLossPerCycle, ViReal64 *EnergyLoss,
													  ViReal64 *PowerLoss);
ViStatus _VI_FUNC agx2k3k_ReadEfficiencyPowerAnalysis(ViSession vi, ViReal64 *InputPower, ViReal64 *OutputPower);
ViStatus _VI_FUNC agx2k3k_ReadOnOffTime(ViSession vi, ViReal64 *TurnOffTime, ViReal64 *TurnOnTime);
ViStatus _VI_FUNC agx2k3k_ConfigureStatisticsType(ViSession vi, ViInt32 MeasureInformationType);
ViStatus _VI_FUNC agx2k3k_ReadDisplayedMeasurements(ViSession vi, ViChar ContinuouslyDisplayedMeasurements[], ViInt32 ResultLength);

/*- Power Group Group Functions ----------------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_ReadPowerHarmonics ( ViSession vi, ViInt32 DataLength, ViChar TableData[]);
ViStatus _VI_FUNC agx2k3k_ReadHarmonicsPowerAnalysis(ViSession vi, ViInt32 *FailCount, ViReal64 *PowerFactor,
													  ViInt32 *IterationCount, ViReal64 *TotalHarmonicsDistortion, ViInt32 *OverallStatus);
ViStatus _VI_FUNC agx2k3k_ConfigurePowerCycleCount(ViSession vi, ViInt32 HarmonicsCycleCount, ViInt32 QualityCycleCount);
ViStatus _VI_FUNC agx2k3k_ConfigurePowerDuration(ViSession vi, ViReal64 EfficiencyDuration, ViReal64 ModulationDuration,
												  ViReal64 TurnOffDuration, ViReal64 TurnOnDuration, ViReal64 RippleDuration,
												  ViReal64 TransientDuration);
ViStatus _VI_FUNC agx2k3k_ConfigurePowerVoltage(ViSession vi, ViReal64 InrushMaxVoltage, ViReal64 TurnOffMaxVoltage,
											  ViReal64 TurnOnMaxVoltage, ViReal64 TurnOffSteadyVoltage, ViReal64 TurnOnSteadyVoltage,
											  ViReal64 TransientSteadyVoltage);
ViStatus _VI_FUNC agx2k3k_ConfigurePowerInrushCurrent(ViSession vi, ViReal64 InrushCurrentAmplitude);

/*- Serial Bus Group Group Functions ----------------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_ReadSBusA429(ViSession vi, ViChar BusName[], ViInt32 *A429ErrorCount, ViInt32 *A429WordCount);
ViStatus _VI_FUNC agx2k3k_ConfigureA429TriggerRange(ViSession vi, ViChar BusName[], ViConstString A429TriggerRange);
ViStatus _VI_FUNC agx2k3k_ReadSBusFlexray(ViSession vi, ViChar BusName[], ViInt32 *FlexSyncFrameCount, ViInt32 *FlexTotalFrameCount);
ViStatus _VI_FUNC agx2k3k_ConfigureFlexTriggerType( ViSession vi, ViChar BusName[], ViInt32 FlexrayTriggerMode);
ViStatus _VI_FUNC agx2k3k_ConfigureUSBTriggerSource2(ViSession vi, ViChar BusName[], ViInt32 Speed, ViInt32 D_Plus, ViInt32 D_Minus);
ViStatus _VI_FUNC agx2k3k_ConfigureUSBTriggerType(ViSession vi, ViChar BusName[], ViInt32 TriggerType);
ViStatus _VI_FUNC agx2k3k_ConfigureUSBPortion(ViSession vi, ViChar BusName[], ViConstString AddressPortion,
											  ViConstString CRCPortion, ViConstString DataPortion, ViInt32 DataLength, ViConstString EndpointPortion);
ViStatus _VI_FUNC agx2k3k_ConfigureUSBPortionAdvanced(ViSession vi, ViChar BusName[], ViConstString ETPortion,
...
ViStatus _VI_FUNC agx2k3k_ConfigureUSBPID(ViSession vi, ViChar BusName[], ViInt32 DataPid,
										  ViInt32 HandshakePid, ViInt32 SpecialPid, ViInt32 TokenPid);
ViStatus _VI_FUNC agx2k3k_ConfigureUSBNormal(ViSession vi, ViChar BusName[], ViInt32 UsbBase, ViInt32 UsbDifferentialSource);

/*- Search Group Group Functions ----------------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_ConfigureSearchUSBType(ViSession vi, ViInt32 SearchType);
ViStatus _VI_FUNC agx2k3k_ConfigureSearchUSBPortion(ViSession vi, ViConstString AddressPortion, ViConstString CRCPortion,
												  ViConstString DataPortion, ViInt32 DataLength, ViConstString EndpointPortion);
ViStatus _VI_FUNC agx2k3k_ConfigureSearchUSBPortionAd(ViSession vi, ViConstString ETPortion, ViConstString FramePortion,
													  ViConstString HubAddressPortion, ViConstString PortPortion, ViConstString SCPortion,
													  ViConstString SEUPortion);
ViStatus _VI_FUNC agx2k3k_ConfigureSearchUSBPID(ViSession vi, ViInt32 DataPid, ViInt32 HandshakePid,
											  ViInt32 SpecialPid, ViInt32 TokenPid);

/*- WGEN Group Group Functions ----------------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_ConfigureArbWaveformData(ViSession vi, ViChar WaveGenChannel[], ViConstString ArbData,
												  ViConstString ArbDacData, ViInt32 PointsCount);
ViStatus _VI_FUNC agx2k3k_ClearArbWaveformData(ViSession vi, ViChar WaveGenChannel[]);
ViStatus _VI_FUNC agx2k3k_StoreArbWaveform(ViSession vi, ViChar WaveGenChannel[], ViInt32 Source);
ViStatus _VI_FUNC agx2k3k_ConfigureModulationAM(ViSession vi, ViChar WaveGenChannel[], ViInt32 DepthPercent, ViReal64 WaveformFrequency);
ViStatus _VI_FUNC agx2k3k_ConfigureModulationFM(ViSession vi, ViChar WaveGenChannel[], ViReal64 Deviation, ViReal64 Frequency);
ViStatus _VI_FUNC agx2k3k_ConfigureModulationFSKey(ViSession vi, ViChar WaveGenChannel[], ViReal64 Frequency, ViReal64 Rate);
ViStatus _VI_FUNC agx2k3k_ConfigureModulationFunction(ViSession vi, ViChar WaveGenChannel[], ViInt32 SignalShape, ViInt32 RampSymmetry);
ViStatus _VI_FUNC agx2k3k_ConfigureModulationState(ViSession vi, ViChar WaveGenChannel[], ViBoolean EnableModulatedWaveform);
ViStatus _VI_FUNC agx2k3k_ConfigureModulationType(ViSession vi, ViChar WaveGenChannel[], ViInt32 ModulationType);
ViStatus _VI_FUNC agx2k3k_ConfigureGeneratorTracking (ViSession vi, ViChar WaveGenChannel[], ViBoolean EnableTracking,
													  ViBoolean EnableAmplitudeTracking, ViBoolean EnableFrequencyTracking, ViBoolean SetIdentical);
ViStatus _VI_FUNC agx2k3k_ConfigureGeneratorInverted(ViSession vi, ViChar WaveGenChannel[], ViInt32 OutputPolarity);

/*- Interpolation Group Group Functions ----------------------------------------------------*/
ViStatus _VI_FUNC agx2k3k_ConfigureInterpolation(ViSession vi, ViInt32 InterpolationMethod);
ViStatus _VI_FUNC agx2k3k_ConfigureInterpolationByChannel ( ViSession vi, ViChar waveGenChannel[], ViInt32 InterpolationMethod);
