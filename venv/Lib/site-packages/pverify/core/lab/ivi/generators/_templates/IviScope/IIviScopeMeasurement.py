...
class IIviScopeMeasurement:
    ...
    def FetchWaveform(self):
        ...
        """
        size = self.root.Acquisition.RecordLength

        WaveformArray, ActualPoints, InitialX, XIncrement =  self.root.dllwrap.FetchWaveform(self.channel,  size)
        data = np_array(WaveformArray)[:ActualPoints]
        return data, InitialX, XIncrement
    ...
    def FetchWaveformMeasurement(self, MeasFunction):
        ...
        """
        return self.root.dllwrap.FetchWaveformMeasurement(self.channel, MeasFunction)
    ...
    def FetchWaveformMinMax(self):
        ...
        MinWaveform, MaxWaveform, ActualPoints, InitialX, XIncrement = self.root.dllwrap.FetchMinMaxWaveform(self.channel, size)
        midata = np_array(MinWaveform)[:ActualPoints]
        madata = np_array(MaxWaveform)[:ActualPoints]
        return midata, madata, InitialX, XIncrement
    ...
    def ReadWaveform(self, MaxTimeMilliseconds):
        ...
        WaveformArray, ActualPoints, InitialX, XIncrement = self.root.dllwrap.ReadWaveform(self.channel, size, MaxTimeMilliseconds)
        data = np_array(WaveformArray)[:ActualPoints]
        return data, InitialX, XIncrement
    ...
    def ReadWaveformMinMax(self, MaxTimeMilliseconds):
        ...
        MinWaveform, MaxWaveform, ActualPoints, InitialX, XIncrement = self.root.dllwrap.FetchMinMaxWaveform(self.channel, size, MaxTimeMilliseconds)
        midata = np_array(MinWaveform)[:ActualPoints]
        madata = np_array(MaxWaveform)[:ActualPoints]
        return midata, madata, InitialX, XIncrement
    ...
    def ReadWaveformMeasurement(self, MeasFunction, MaxTimeMilliseconds):
        ...
        :type MaxTimeMilliseconds: int
        """
        return self.root.dllwrap.ReadWaveformMeasurement(self.channel, MeasFunction,MaxTimeMilliseconds)
