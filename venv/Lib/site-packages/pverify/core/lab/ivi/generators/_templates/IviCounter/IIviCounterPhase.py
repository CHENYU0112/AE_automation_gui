...
class IIviCounterPhase:
    ...
    def InputChannel(self):
        return self.root.dllwrap.GetAttributeViString(None, IVI_CLASS_PUBLIC_ATTR_BASE + 43, 1024)
    ...
    def InputChannel(self, value):
        ...
        """
        self.root.dllwrap.SetAttributeViString(None, IVI_CLASS_PUBLIC_ATTR_BASE + 43, value)

    @property
    def ReferenceChannel(self):
        return self.root.dllwrap.GetAttributeViString(None, IVI_CLASS_PUBLIC_ATTR_BASE + 44, 1024)
    ...
    def ReferenceChannel(self, value):
        ...
        """
        self.root.dllwrap.SetAttributeViString(None, IVI_CLASS_PUBLIC_ATTR_BASE + 44, value)

    @property
    def FrequencyEstimate(self):
        return self.root.dllwrap.GetAttributeViReal64(None, IVI_CLASS_PUBLIC_ATTR_BASE + 45)
    ...
    def FrequencyEstimate(self, value):
        ...
        channel.
        """
        self.root.dllwrap.SetAttributeViReal64(None, IVI_CLASS_PUBLIC_ATTR_BASE + 45, value)

    @property
    def Resolution(self):
        return self.root.dllwrap.GetAttributeViReal64(None, IVI_CLASS_PUBLIC_ATTR_BASE + 46)
    ...
    def Resolution(self, value):
        ...
        reference channel.
        """
        self.root.dllwrap.SetAttributeViReal64(None, IVI_CLASS_PUBLIC_ATTR_BASE + 46, value)
    ...
    def Configure(self, InputChannel, ReferenceChannel, FrequencyEstimate, Resolution):
        ...
        """
        self.root.dllwrap.ConfigurePhase(,
                                         InputChannel,
                                         ReferenceChannel,
                                         FrequencyEstimate,
                                         Resolution)
