...
ViStatus niHSDIO_InitAcquisitionSession (
   ViRsrc resourceName,
   ViBoolean IDQuery,
   ViBoolean resetDevice,
   ViConstString optionString,
   ViSession *vi);
ViStatus niHSDIO_InitGenerationSession (
   ViRsrc resourceName,
   ViBoolean IDQuery,
   ViBoolean resetDevice,
   ViConstString optionString,
   ViSession *vi);
ViStatus niHSDIO_close (
   ViSession vi);

/* Locking Functions */
ViStatus niHSDIO_LockSession (
   ViSession vi,
...
/* Control Functions */
ViStatus niHSDIO_Initiate (
   ViSession vi);
ViStatus niHSDIO_Abort (
   ViSession vi);
ViStatus niHSDIO_CommitStatic (
   ViSession vi);
ViStatus niHSDIO_CommitDynamic (
   ViSession vi);
ViStatus niHSDIO_WaitUntilDone (
   ViSession vi,
   ViInt32 maxTime);
ViStatus niHSDIO_IsDone (
   ViSession vi,
   ViBoolean* done);
ViStatus niHSDIO_TristateChannels (
   ViSession vi,
   ViConstString channelList,
   ViBoolean tristate);

/* Static I/O Functions */
ViStatus niHSDIO_AssignStaticChannels (
   ViSession vi,
   ViConstString channelList);
ViStatus niHSDIO_WriteStaticU32 (
   ViSession vi, ViUInt32 writeData,
   ViUInt32 channelMask);
ViStatus niHSDIO_ReadStaticU32 (
   ViSession vi,
   ViUInt32* data);
...
ViStatus niHSDIO_ConfigureDataVoltageLogicFamily (
   ViSession vi,
   ViConstString channelList,
   ViInt32 logicFamily);
ViStatus niHSDIO_ConfigureDataVoltageCustomLevels (
   ViSession vi,
   ViConstString channelList,
   ViReal64 lowLevel,
   ViReal64 highLevel);
ViStatus niHSDIO_ConfigureTriggerVoltageLogicFamily (
   ViSession vi,
   ViInt32 logicFamily);
ViStatus niHSDIO_ConfigureTriggerVoltageCustomLevels (
   ViSession vi,
   ViReal64 lowLevel,
   ViReal64 highLevel);
ViStatus niHSDIO_ConfigureEventVoltageLogicFamily (
   ViSession vi,
   ViInt32 logicFamily);
ViStatus niHSDIO_ConfigureEventVoltageCustomLevels(
   ViSession vi,
   ViReal64 lowLevel,
   ViReal64 highLevel);

/* Timing Configuration Functions */
ViStatus niHSDIO_ConfigureRefClock (
   ViSession vi,
   ViConstString clockSource,
   ViReal64 clockRate);
ViStatus niHSDIO_ConfigureSampleClock (
   ViSession vi,
   ViConstString clockSource,
   ViReal64 clockRate);
ViStatus niHSDIO_ConfigureDataPosition (
   ViSession vi,
   ViConstString channelList,
   ViInt32 position);
ViStatus niHSDIO_ConfigureDataPositionDelay (
   ViSession vi,
   ViConstString channelList,
   ViReal64 delay);
...
/* Triggers Functions */
ViStatus niHSDIO_SendSoftwareEdgeTrigger (
   ViSession vi,
   ViInt32 triggerName,
   ViConstString triggerIdentifier);

ViStatus niHSDIO_ConfigureDigitalLevelPauseTrigger (
   ViSession vi,
   ViConstString source,
   ViInt32 level);
ViStatus niHSDIO_DisablePauseTrigger (
   ViSession vi);
...
ViStatus niHSDIO_ConfigureDigitalEdgeScriptTrigger (
   ...
   ViConstString source,
   ViInt32 edge);
ViStatus niHSDIO_ConfigureDigitalLevelScriptTrigger (
   ViSession vi,
   ViConstString triggerID,
   ViConstString source,
   ViInt32 level);
ViStatus niHSDIO_DisableScriptTrigger (
   ViSession vi,
   ViConstString triggerID);
ViStatus niHSDIO_ConfigureSoftwareScriptTrigger (
   ViSession vi,
   ViConstString triggerID);

ViStatus niHSDIO_ConfigureDigitalEdgeStartTrigger (
   ViSession vi,
   ViConstString source,
   ViInt32 edge);
ViStatus niHSDIO_DisableStartTrigger (
   ViSession vi);
ViStatus niHSDIO_ConfigureSoftwareStartTrigger (
   ViSession vi);
ViStatus niHSDIO_ConfigurePatternMatchStartTrigger (
   ViSession vi,
   ViConstString channelList,
   ViConstString pattern,
   ViInt32 triggerWhen);
ViStatus niHSDIO_ConfigurePatternMatchStartTriggerU32 (
   ViSession vi,
   ViConstString channelList,
   ViUInt32 pattern,
   ViInt32 triggerWhen);
...
ViStatus niHSDIO_ConfigureDigitalEdgeAdvanceTrigger (
   ViSession vi,
   ViConstString source,
   ViInt32 edge);
ViStatus niHSDIO_DisableAdvanceTrigger (
   ViSession vi);
ViStatus niHSDIO_ConfigureSoftwareAdvanceTrigger (
   ViSession vi);
ViStatus niHSDIO_ConfigurePatternMatchAdvanceTrigger (
   ViSession vi,
   ViConstString channelList,
   ViConstString pattern,
   ViInt32 triggerWhen);
...
ViStatus niHSDIO_ConfigureDigitalEdgeRefTrigger (
   ViSession vi,
   ViConstString source,
   ViInt32 edge,
   ViInt32 pretriggerSamples);
ViStatus niHSDIO_DisableRefTrigger (
   ViSession vi);
ViStatus niHSDIO_ConfigureSoftwareRefTrigger (
   ViSession vi,
   ViInt32 pretriggerSamples);
ViStatus niHSDIO_ConfigurePatternMatchRefTrigger (
   ViSession vi,
   ViConstString channelList,
   ViConstString pattern,
   ViInt32 triggerWhen,
   ViInt32 pretrigSamples);
ViStatus niHSDIO_ConfigurePatternMatchRefTriggerU32 (
   ViSession vi,
   ViConstString channelList,
   ViUInt32 pattern,
   ViInt32 triggerWhen,
...
ViStatus niHSDIO_ConfigureDigitalEdgeStopTrigger (
   ViSession vi,
   ViConstString source,
   ViInt32 edge);
ViStatus niHSDIO_DisableStopTrigger (
   ViSession vi);
ViStatus niHSDIO_ConfigureSoftwareStopTrigger (
   ViSession vi);

/* Events Functions */
ViStatus niHSDIO_ExportSignal (
   ViSession vi,
   ViInt32 signal,
...
ViStatus niHSDIO_AssignDynamicChannels (
   ViSession vi,
   ViConstString channelList);
ViStatus niHSDIO_AllocateNamedWaveform (
   ViSession vi,
   ViConstString waveformName,
   ViInt32 sizeInSamples);
ViStatus niHSDIO_DeleteNamedWaveform (
   ViSession vi,
   ViConstString waveformName);
ViStatus niHSDIO_WriteNamedWaveformU32 (
   ViSession vi,
   ViConstString waveformName,
...
ViStatus niHSDIO_ConfigureGenerationMode (
   ViSession vi,
   ViInt32 generationMode);
ViStatus niHSDIO_ConfigureGenerationRepeat (
   ViSession vi,
   ViInt32 repeatMode,
   ViInt32 repeatCount);
...
ViStatus niHSDIO_ConfigureWaveformToGenerate (
   ViSession vi,
   ViConstString waveformName);
ViStatus niHSDIO_ConfigureScriptToGenerate (
   ViSession vi,
...
ViStatus niHSDIO_ConfigureInitialStateU32 (
   ViSession vi,
   ViUInt32 initialState);
ViStatus niHSDIO_ConfigureIdleState (
   ViSession vi,
   ViConstString channelList,
...
ViStatus niHSDIO_ConfigureIdleStateU32 (
   ViSession vi,
   ViUInt32 idleState);
ViStatus niHSDIO_SetNamedWaveformNextWritePosition (
   ViSession vi,
   ViConstString waveformName,
   ViInt32 relativeTo,
   ViInt32 offset);
...
ViStatus niHSDIO_ConfigureAcquisitionSize (
   ViSession vi,
   ViInt32 samplesPerRecord,
   ViInt32 numberOfRecords);
ViStatus niHSDIO_ConfigureDataInterpretation (
   ViSession vi,
   ViConstString channelList,
   ViInt32 dataInterpretation);
ViStatus niHSDIO_GetFetchBacklog(
   ViSession vi,
   ViInt32 recordNumber,
   ViInt32* backlog);
ViStatus niHSDIO_FetchMultiRecordU32 (
   ViSession vi,
   ...
   ViInt32 numberOfRecords,
   ViUInt32 data[],
   niHSDIO_wfmInfo wfmInfo[]);
ViStatus niHSDIO_FetchMultiRecordU16 (
   ViSession vi,
   ViInt32 samplesToRead,
   ViInt32 maxTimeMilliseconds,
   ViInt32 startingRecord,
   ...
   ViUInt16 data[],
   niHSDIO_wfmInfo wfmInfo[]);
ViStatus niHSDIO_FetchMultiRecordU8 (
   ViSession vi,
   ViInt32 samplesToRead,
   ViInt32 maxTimeMilliseconds,
   ViInt32 startingRecord,
   ...
   ViUInt8 data[],
   niHSDIO_wfmInfo wfmInfo[]);
ViStatus niHSDIO_FetchWaveformU32 (
   ViSession vi,
   ViInt32 samplesToRead,
   ViInt32 maxTimeMilliseconds,
   ViInt32* numberOfSamplesRead,
   ViUInt32 data[]);
ViStatus niHSDIO_FetchWaveformU16 (
   ViSession vi,
   ViInt32 samplesToRead,
   ViInt32 maxTimeMilliseconds,
   ViInt32* numberOfSamplesRead,
   ViUInt16 data[]);
ViStatus niHSDIO_FetchWaveformU8 (
   ViSession vi,
   ViInt32 samplesToRead,
   ViInt32 maxTimeMilliseconds,
   ViInt32* numberOfSamplesRead,
   ViUInt8 data[]);
ViStatus niHSDIO_FetchWaveformDirectDMA (
   ViSession vi,
   ViInt32 samplesToRead,
   ViInt32 maxTimeMilliseconds,
   ViUInt32 bufferSize,
...
ViStatus niHSDIO_ReadWaveformU32 (
   ViSession vi,
   ViInt32 samplesToRead,
   ViInt32 maxTimeMilliseconds,
   ViInt32* numberOfSamplesRead,
   ViUInt32 data[]);
ViStatus niHSDIO_ReadWaveformU16 (
   ViSession vi,
   ViInt32 samplesToRead,
   ViInt32 maxTimeMilliseconds,
   ViInt32* numberOfSamplesRead,
   ViUInt16 data[]);
ViStatus niHSDIO_ReadWaveformU8 (
   ViSession vi,
   ViInt32 samplesToRead,
   ViInt32 maxTimeMilliseconds,
   ViInt32* numberOfSamplesRead,
   ViUInt8 data[]);
ViStatus niHSDIO_ReadMultiRecordU32 (
   ViSession vi,
   ViInt32 samplesToRead,
   ViInt32 maxTimeMilliseconds,
   ViInt32 startingRecord,
   ...
   ViUInt32 data[],
   niHSDIO_wfmInfo wfmInfo[]);
ViStatus niHSDIO_ReadMultiRecordU16 (
   ViSession vi,
   ViInt32 samplesToRead,
   ViInt32 maxTimeMilliseconds,
   ViInt32 startingRecord,
   ...
   ViUInt16 data[],
   niHSDIO_wfmInfo wfmInfo[]);
ViStatus niHSDIO_ReadMultiRecordU8 (
   ViSession vi,
   ViInt32 samplesToRead,
   ViInt32 maxTimeMilliseconds,
   ViInt32 startingRecord,
...
/* Error Functions */
ViStatus niHSDIO_error_message (
   ViSession vi,
   ViStatus errorCode,
   ViChar errorMessage[256]);
ViStatus niHSDIO_GetError (
   ViSession vi,
   ViStatus* errorCode,
   ViInt32 errorDescriptionBufferSize,
   ViChar errorDescription[]);
ViStatus niHSDIO_ClearError (
   ViSession vi);

/* Utility Functions */
ViStatus niHSDIO_reset (
   ViSession vi);
ViStatus niHSDIO_self_test (
   ViSession vi,
   ViInt16 *selfTestResult,
   ViChar selfTestMessage[]);
ViStatus niHSDIO_SelfCal (
   ViSession vi);
ViStatus niHSDIO_ResetDevice (
   ViSession vi);


/* Set and Get Attribute Functions */
ViStatus niHSDIO_GetAttributeViInt32 (
   ViSession vi,
   ViConstString channelName,
   ViAttr attribute,
   ViInt32 *value);
ViStatus niHSDIO_GetAttributeViReal64 (
   ViSession vi,
   ViConstString channelName,
   ViAttr attribute,
   ViReal64 *value);
ViStatus niHSDIO_GetAttributeViString (
   ViSession vi,
   ViConstString channelName,
   ViAttr attribute,
   ViInt32 bufSize,
   ViChar value[]);
ViStatus niHSDIO_GetAttributeViSession (
   ViSession vi,
   ViConstString channelName,
   ViAttr attribute,
   ViSession *value);
ViStatus niHSDIO_GetAttributeViBoolean (
   ViSession vi,
   ViConstString channelName,
   ViAttr attribute,
   ViBoolean *value);

ViStatus niHSDIO_SetAttributeViInt32 (
   ViSession vi,
   ViConstString channelName,
   ViAttr attribute,
   ViInt32 value);
ViStatus niHSDIO_SetAttributeViReal64 (
   ViSession vi,
   ViConstString channelName,
   ViAttr attribute,
   ViReal64 value);
ViStatus niHSDIO_SetAttributeViString (
   ViSession vi,
   ViConstString channelName,
   ViAttr attribute,
   ViConstString value);
ViStatus niHSDIO_SetAttributeViSession (
   ViSession vi,
   ViConstString channelName,
   ViAttr attribute,
   ViSession value);
ViStatus niHSDIO_SetAttributeViBoolean (
   ViSession vi,
   ViConstString channelName,
   ViAttr attribute,
   ViBoolean value);
...
/* Reset Attribute */
ViStatus niHSDIO_ResetAttribute (
   ViSession vi,
   ViConstString channelName,
   ViAttr attributeId);

/* Software Timed PMU Functions */
ViStatus niHSDIO_STPMU_SourceVoltage (
   ViSession vi,
   ViConstString channelList,
...
ViStatus niHSDIO_STPMU_DisablePMU (
   ...
   ViConstString channelList,
   ViInt32 returnState);
ViStatus niHSDIO_STPMU_MeasureVoltage (
   ViSession vi,
   ViConstString channelList,
...
ViStatus niHSDIO_STPMU_MeasureCurrent (
   ViSession vi,
   ViConstString channelList,
   ViReal64 apertureTime,
   ViReal64 measurements[],
   ViInt32 *numberOfMeasurements);
ViStatus niHSDIO_STPMU_ExternalForceControl (
   ViSession vi,
   ViConstString channelList,
   ViInt32 action,
   ViInt32 connector);
ViStatus niHSDIO_STPMU_ExternalSenseControl (
   ViSession vi,
...
ViStatus niHSDIO_CalCloseChildSession (
   ViSession vi,
   ViSession childSession);
ViStatus niHSDIO_CalAdjustChannelVoltage (
   ViSession vi,
   ViConstString channel);
ViStatus niHSDIO_CalAdjustChannelSkew (
   ViSession vi,
   ViConstString channel);
ViStatus niHSDIO_CalAdjustTerminalSkew (
   ViSession vi,
   ViConstString channel);
ViStatus niHSDIO_GetSelfCalSupported (
   ViSession vi,
   ViBoolean* selfCalSupported);
ViStatus niHSDIO_GetSelfCalLastDateAndTime (
   ViSession vi,
   ViInt32* year,
   ViInt32* month,
   ViInt32* day,
   ViInt32* hour,
   ViInt32* minute);
ViStatus niHSDIO_GetExtCalLastDateAndTime (
   ViSession vi,
   ViInt32* year,
   ViInt32* month,
   ViInt32* day,
   ViInt32* hour,
   ViInt32* minute);
ViStatus niHSDIO_GetSelfCalLastTemp (
   ViSession vi,
   ViReal64* temp);
ViStatus niHSDIO_GetExtCalLastTemp (
   ViSession vi,
   ViReal64* temp);
ViStatus niHSDIO_ReadCurrentTemperature (
   ViSession vi,
   ViReal64* temp);
ViStatus niHSDIO_GetExtCalRecommendedInterval (
   ViSession vi,
   ViInt32* interval);
ViStatus niHSDIO_ChangeExtCalPassword (
   ViSession vi,
   ViConstString oldPassword,
   ViConstString newPassword);
ViStatus niHSDIO_SetCalUserDefinedInfo (
   ViSession vi,
   ViConstString info);
ViStatus niHSDIO_GetCalUserDefinedInfo (
   ViSession vi,
   ViString info);
ViStatus niHSDIO_GetCalUserDefinedInfoMaxSize (
   ViSession vi,
   ViInt32* infoSize);
ViStatus niHSDIO_CloseExtCal(
   ViSession vi,
   ViInt32 action);
ViStatus niHSDIO_RecordExtCalVerification(
   ViSession vi,
   ViConstString password);
