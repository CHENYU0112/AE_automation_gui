...
class TransientTestFrame(TestFrame):
    ...
    def create_scope_frame(self):
        ...
        tk.Label(frame, text="Scope", font=FONT_BOLD, bg='white', fg="black").place(x=5, y=5)
        tk.Label(frame, text=self.instrument_manager.instruments['o_scope'], font=FONT_BOLD, bg='white', fg="black").place(x=115, y=5)
